...
export function updatePriceAlert(id: string, input: Partial<Pick<PriceAlert, 'targetPrice' | 'direction' | 'repeat'>>) { return apiFetch<PriceAlert>(`/api/alerts/${encodeURIComponent(id)}`, { method: 'PATCH', body: JSON.stringify(input) }) }
