...
.page-header { display: flex; align-items: flex-end; justify-content: space-between; gap: 20px; margin-bottom: 22px; }.eyebrow { margin: 0; color: var(--primary); font: 500 10px 'JetBrains Mono', monospace; letter-spacing: .12em; }.page-header h1 { margin: 6px 0 0; font-size: 26px; letter-spacing: -.04em; }.subtitle { margin-top: 9px; color: var(--muted); font-size: 12px; }.refresh { padding: 8px 12px; color: var(--primary); background: var(--card); border: 1px solid var(--border); border-radius: 5px; font-size: 12px; }.refresh span { display: inline-block; margin-right: 4px; font-size: 17px; }.spinning { animation: rotate .7s linear infinite; }
