...
<template>
  <section class="notifications-page">
    ...
    <LoadingState v-if="isLoading" label="正在加载消息" />
    <ErrorState v-else-if="loadError" title="消息加载失败" :message="loadError" :retry="loadMessages" />
    <section v-else-if="messages.length" class="message-list panel" aria-label="消息列表">
