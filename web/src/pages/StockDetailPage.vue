...
const detailTabs = ['分时 / K线', '盘口', '资金流向', '基本面']
...
onMounted(async () => {
  ...
  await loadChartData()
  await Promise.all([loadRelatedReports(), loadDetail()])
