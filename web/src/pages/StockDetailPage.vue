...
const detailTabs = ['分时 / K线', '盘口', '资金流向', '资讯', '公告', '研报', '财务', '财报', '股东/分红', '机构/大宗', '解禁']
