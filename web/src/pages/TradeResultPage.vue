...
<template>
  <section class="trade-flow-page result-page">
    ...
    <div class="result-actions">
      ...
      <button class="primary-button" type="button" @click="emit('orders')">查看当日委托</button>
