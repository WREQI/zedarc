...
import { getTradePosition, loadDemoAccount, type DemoHolding, type TradePosition } from '@/services/trade'
...
onMounted(async () => {
  ...
  try {
    if (getAccessToken()) {
      const item = await getTradePosition(code)
