...
const serviceEntries = [
  { icon: '◎', title: '个人资料', note: '账户信息与头像', to: '/settings?section=profile' },
  { icon: '◇', title: '安全中心', note: '登录状态与设备安全', to: '/settings?section=security' },
  { icon: '⌁', title: '登录设备', note: '管理已登录设备', to: '/settings?section=devices' },
