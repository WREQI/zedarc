  ...
  return (
          ...
          for (var o = [], s = 0; s < i; s += 3)
            for (
              var a = (r[s >>> 2] >>> (24 - (s % 4) * 8)) & 255,
                c = (r[(s + 1) >>> 2] >>> (24 - ((s + 1) % 4) * 8)) & 255,
                h = (r[(s + 2) >>> 2] >>> (24 - ((s + 2) % 4) * 8)) & 255,
                l = (a << 16) | (c << 8) | h,
                f = 0;
              f < 4 && s + 0.75 * f < i;
              f++
      ...
      var a = (o.MD5 = n.extend({
        ...
        _doProcessBlock: function (t, e) {
          ...
          var o = this._hash.words,
            ...
            D = o[3];
          (H = h(H, z, C, D, a, 7, s[0])),
            (D = h(D, H, z, C, c, 12, s[1])),
            (C = h(C, D, H, z, d, 17, s[2])),
            (z = h(z, C, D, H, p, 22, s[3])),
            (H = h(H, z, C, D, _, 7, s[4])),
            (D = h(D, H, z, C, v, 12, s[5])),
            (C = h(C, D, H, z, y, 17, s[6])),
            (z = h(z, C, D, H, g, 22, s[7])),
            (H = h(H, z, C, D, B, 7, s[8])),
            (D = h(D, H, z, C, w, 12, s[9])),
            (C = h(C, D, H, z, k, 17, s[10])),
            (z = h(z, C, D, H, m, 22, s[11])),
            (H = h(H, z, C, D, S, 7, s[12])),
            (D = h(D, H, z, C, x, 12, s[13])),
            (C = h(C, D, H, z, b, 17, s[14])),
            (H = l(H, (z = h(z, C, D, H, A, 22, s[15])), C, D, c, 5, s[16])),
            (D = l(D, H, z, C, y, 9, s[17])),
            (C = l(C, D, H, z, m, 14, s[18])),
            (z = l(z, C, D, H, a, 20, s[19])),
            (H = l(H, z, C, D, v, 5, s[20])),
            (D = l(D, H, z, C, k, 9, s[21])),
            (C = l(C, D, H, z, A, 14, s[22])),
            (z = l(z, C, D, H, _, 20, s[23])),
            (H = l(H, z, C, D, w, 5, s[24])),
            (D = l(D, H, z, C, b, 9, s[25])),
            (C = l(C, D, H, z, p, 14, s[26])),
            (z = l(z, C, D, H, B, 20, s[27])),
            (H = l(H, z, C, D, x, 5, s[28])),
            (D = l(D, H, z, C, d, 9, s[29])),
            (C = l(C, D, H, z, g, 14, s[30])),
            (H = f(H, (z = l(z, C, D, H, S, 20, s[31])), C, D, v, 4, s[32])),
            (D = f(D, H, z, C, B, 11, s[33])),
            (C = f(C, D, H, z, m, 16, s[34])),
            (z = f(z, C, D, H, b, 23, s[35])),
            (H = f(H, z, C, D, c, 4, s[36])),
            (D = f(D, H, z, C, _, 11, s[37])),
            (C = f(C, D, H, z, g, 16, s[38])),
            (z = f(z, C, D, H, k, 23, s[39])),
            (H = f(H, z, C, D, x, 4, s[40])),
            (D = f(D, H, z, C, a, 11, s[41])),
            (C = f(C, D, H, z, p, 16, s[42])),
            (z = f(z, C, D, H, y, 23, s[43])),
            (H = f(H, z, C, D, w, 4, s[44])),
            (D = f(D, H, z, C, S, 11, s[45])),
            (C = f(C, D, H, z, A, 16, s[46])),
            (H = u(H, (z = f(z, C, D, H, d, 23, s[47])), C, D, a, 6, s[48])),
            (D = u(D, H, z, C, g, 10, s[49])),
            (C = u(C, D, H, z, b, 15, s[50])),
            (z = u(z, C, D, H, v, 21, s[51])),
            (H = u(H, z, C, D, S, 6, s[52])),
            (D = u(D, H, z, C, p, 10, s[53])),
            (C = u(C, D, H, z, k, 15, s[54])),
            (z = u(z, C, D, H, c, 21, s[55])),
            (H = u(H, z, C, D, B, 6, s[56])),
            (D = u(D, H, z, C, A, 10, s[57])),
            (C = u(C, D, H, z, y, 15, s[58])),
            (z = u(z, C, D, H, x, 21, s[59])),
            (H = u(H, z, C, D, _, 6, s[60])),
            (D = u(D, H, z, C, m, 10, s[61])),
            (C = u(C, D, H, z, d, 15, s[62])),
            (z = u(z, C, D, H, w, 21, s[63])),
            (o[0] = (o[0] + H) | 0),
            (o[1] = (o[1] + z) | 0),
            (o[2] = (o[2] + C) | 0),
            (o[3] = (o[3] + D) | 0);
      ...
      var l = (o.SHA512 = e.extend({
        ...
        _doProcessBlock: function (t, e) {
          ...
          (p = i.low = p + D),
            ...
            (m = c.low = m + I),
            (c.high = k + O + (m >>> 0 < I >>> 0 ? 1 : 0)),
            (x = l.low = x + K),
            (l.high = S + U + (x >>> 0 < K >>> 0 ? 1 : 0)),
            (A = f.low = A + L),
            (f.high = b + X + (A >>> 0 < L >>> 0 ? 1 : 0)),
            (z = u.low = z + T),
          ...
          v = ((e.format = {}).OpenSSL = {
            stringify: function (t) {
              var e = t.ciphertext,
                r = t.salt;
              return (
                r ? n.create([1398893684, 1701076831]).concat(r).concat(e) : e
              ).toString(a);
            },
            parse: function (t) {
              var e,
    ...
    (c.pad.Iso10126 = {
      pad: function (t, e) {
        var r = 4 * e,
          i = r - (t.sigBytes % r);
        t.concat(c.lib.WordArray.random(i - 1)).concat(
          c.lib.WordArray.create([i << 24], 1)
        );
      },
      unpad: function (t) {
        var e = 255 & t.words[(t.sigBytes - 1) >>> 2];
