        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.BEACON_ATTA_REQUEST_URL =
            ...
            e.BEACON_HTTP_URL =
              void 0),
          (e.BEACON_HTTP_URL =
            "http://oth.eve.mdt.qq.com:8080/analytics/v2_upload"),
          (e.BEACON_HTTPS_URL =
      ...
      function (t, e, n) {
        ...
        Object.defineProperty(e, "EventEmiter", {
          ...
          (e.getEventId = function (t) {
            return (
              String(t[r.BEACON_IS_REALTIME_KEY]) +
              String(t[r.BEACON_LOG_ID_KEY])
            );
          });
      },
      function (t, e, n) {
        ...
        e.createPipeline = function (t) {
          if (!t || !t.reduce || !t.length)
            throw new TypeError(
              "createPipeline 鏂规硶闇€瑕佷紶鍏ヨ嚦灏戞湁涓€涓� pipe 鐨勬暟缁�"
            );
          return 1 === t.length
            ? function (e, n) {
                t[0](e, n || r);
          ...
          o = (function () {
            function t(t, e, n, o) {
              ...
              this.needRequestConfig() &&
                this.requestConfig(t.appVersion, e, o);
            }
            return (
              (t.prototype.requestConfig = function (t, e, n) {
                var o = this;
                this.storage.setItem(
                  r.BEACON_CONFIG_REQUEST_TIME,
                  Date.now().toString()
                ),
                  n
                    ...
                    .then(function (t) {
                      if (0 == t.data.ret)
                        ...
                        o.processData(null),
                          o.storage.setItem(r.BEACON_CONFIG, "");
                    })
                    .catch(function (t) {});
              }),
              (t.prototype.processData = function (t) {
                ...
                (this.strategy.isEventUpOnOff =
                  null !== (e = null == t ? void 0 : t.isEventUpOnOff) &&
                  void 0 !== e
                    ? e
                    : this.strategy.isEventUpOnOff),
                  (this.strategy.httpsUploadUrl =
                    null !== (n = null == t ? void 0 : t.httpsUploadUrl) &&
                    void 0 !== n
                      ? n
                      : this.strategy.httpsUploadUrl),
                  (this.strategy.requestInterval =
                    null !== (r = null == t ? void 0 : t.requestInterval) &&
                    void 0 !== r
                      ? r
                      : this.strategy.requestInterval),
                  (this.strategy.blacklist =
                    null !== (o = null == t ? void 0 : t.blacklist) &&
                    void 0 !== o
                      ? o
                      : this.strategy.blacklist),
                  (this.strategy.samplelist =
                    null !== (i = null == t ? void 0 : t.samplelist) &&
                    void 0 !== i
                      ? i
                      : this.strategy.samplelist);
                for (
                  var s = 0, a = this.strategy.samplelist;
                  s < a.length;
                  s++
                ) {
                  var c = a[s].split(",");
              ...
              (t.prototype.needRequestConfig = function () {
                var t = Number(
                  this.storage.getItem(r.BEACON_CONFIG_REQUEST_TIME)
                );
                return (
                  Date.now() - t > 60 * this.strategy.requestInterval * 1e3
                );
              }),
              ...
              return (
                (n.send = function (t, e, r) {
                  ...
                  n.network
                    ...
                    .then(function (r) {
                      100 == r.data.result
                        ? (n.delayTime = 1e3 * r.data.delayTime)
                        : (n.delayTime = 0),
                        e && e(t.data),
                    ...
                    .catch(function (e) {
                      var o = t.data.events;
                      n.errorReport.reportError(
                        e.code ? e.code.toString() : "600",
                        e.message
                      ),
                        r && r(t.data),
                        n.concatEvents(o);
                ...
                (n.errorReport = new c.default(
                  n.config,
                  n.commonInfo,
                  "weapp",
                  n.network
                )),
                (n.strategy = new l.default(
                  n.config,
                  n.commonInfo,
                  n.storage,
                  n.network
            ...
            return (
              ...
              (e.prototype.initCommonInfo = function (t, e) {
                _.getNetworkType({
                  ...
                  (this.config.appVersion = t.versionCode
                    ? String(t.versionCode)
                    : ""),
              ...
              (e.prototype.cycleSend = function (t) {
                var e = this;
                setTimeout(function () {
                  e.realSend(e.getEvents()),
                    e.cycleSend(
                      0 == e.delayTime ? e.initDelayTime : e.delayTime
                    );
                }, t);
              }),
              (e.prototype.onReport = function (t, e, n) {
                var r = [],
                  o =
                    "4.2.6-weapp_" +
                    (n
                      ? u.BEACON_DRIECT_LOG_ID_KEY
                      : u.BEACON_NORMAL_LOG_ID_KEY),
                  ...
                  var r = this.getSystemInfo(),
                    o = {
                      appVersion: this.config.appVersion
                        ? p.replaceSymbol(this.config.appVersion)
                        : "",
                      sdkVersion: "4.2.6-weapp",
                      sdkId: "weapp",
                      ...
                      common: p.replace(
                        i(i({}, this.additionalParams), {
                          ...
                          A102:
                            null ===
                              (n =
                                null === (e = getCurrentPages()) || void 0 === e
                                  ? void 0
                                  : e.pop()) || void 0 === n
                              ? void 0
                              : n.route,
              ...
              (e.prototype.getEvents = function () {
                ...
                try {
                  e = JSON.parse(
                    this.storage.getItem(u.BEACON_SENDING_IDS_KEY)
                  );
                } catch (t) {}
                for (
                  var r = 0, o = Object.getOwnPropertyNames(n);
                  r < o.length;
                  r++
                ) {
                  var i = o[r],
              ...
              (e.prototype.cleanEvents = function (t) {
                for (
                  var e = this.getLocalEvents(), n = 0, r = t;
                  n < r.length;
                  n++
                ) {
                  var o = r[n],
              ...
              (t.prototype.post = function (t, e, n) {
                ...
                return new Promise(function (o, i) {
                  _.request({
                    ...
                    fail: function (t) {
                      var e = { message: t.errMsg, code: "600", request: r };
                      i(e);
                    },
                  });
                });
          ...
          y = (function () {
            ...
            return (
              ...
              (t.prototype.createDeviceId = function () {
                ...
                return (
                  (t && "" != t) ||
                    ((t = this.getRandom(36)), _.setStorageSync("beacon_u", t)),
                  t
                );
              }),
              (t.prototype.getRandom = function (t) {
                return (
                  (1e6 * Date.now() + Math.floor(1e6 * Math.random())).toString(
                    t
                  ) || ""
                );
              }),
          ...
          c = (function () {
            ...
            return (
              ...
              (t.prototype.removeSendingId = function (t) {
                var e = JSON.parse(
                    this.storage.getItem(a.BEACON_SENDING_IDS_KEY)
                  ),
                  n = e.indexOf(t);
                -1 != n &&
                  (e.splice(n, 1),
                  this.storage.setItem(
                    a.BEACON_SENDING_IDS_KEY,
                    JSON.stringify(e)
                  ));
              }),
              t
                ...
                if (null == o ? void 0 : o.length) {
                  ...
                  for (var i = 0; i < o.length; i++) {
                    ...
                    try {
                      ...
                      if ((1 === r.type && t.remove(e, r.callback), !1 === s))
                        break;
                    } catch (t) {
                      throw t;
                    }
          ...
          return (
            ...
            (t.prototype.on = function (t, e, n) {
              if ((void 0 === n && (n = 0), this)) {
                ...
                if (
                  (r || (r = this.__EventsList[t] = []),
                  -1 === this.indexOf(r, e))
                ) {
                  var o = { name: t, type: n || 0, callback: e };
