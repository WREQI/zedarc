  ...
  return function (path, global) {
    ...
    function gz$gwx0_XC_4_1() {
      ...
      (function (z) {
        ...
        Z([3, "_div basket-header-wrapper"]);
        Z([3, "basket-header-wrapper"]);
        Z([[7], [3, "c"]]);
        Z([3, "__l"]);
        Z([[7], [3, "b"]]);
        Z([[7], [3, "a"]]);
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var eXS = _mz(z, "view", ["class", 0, "ref", 1], [], e, s, gg);
      var bYS = _v();
      _(eXS, bYS);
      if (_oz(z, 2, e, s, gg)) {
        bYS.wxVkey = 1;
...
if (!noCss) {
  __wxAppCode__[
    "pages/stockBasket/@tencent/wzq-lite-basket/components/basketEmbedHeader.wxss"
  ] = setCssToHead([], undefined, {
    path: "./pages/stockBasket/@tencent/wzq-lite-basket/components/basketEmbedHeader.wxss",
  });
}
