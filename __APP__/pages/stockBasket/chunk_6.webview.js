...
if (!noCss) {
  __wxAppCode__[
    "pages/stockBasket/@tencent/wzq-lite-basket/components/basketForChoose.wxss"
  ] = setCssToHead([], undefined, {
    path: "./pages/stockBasket/@tencent/wzq-lite-basket/components/basketForChoose.wxss",
  });
}
