var e = require("../../../../@babel/runtime/helpers/slicedToArray"),
  ...
  l = require("../stock-news-sdk/index.js"),
  s = function (e, t, n, i) {
    l.sdk.navigateToNewsDetail(o({ instance: e, id: t, title: n }, i));
  },
  u = function (e, t, n) {
    l.sdk.navigateToVideoDetail(o({ instance: e, id: t }, n));
  },
  y = new Map([
    [
      { type: 0, specalType: 0 },
    ...
    [
      ...
      function (e, t, n) {
        !(function (e, t, n) {
          l.sdk.navigateToMorningReport(o({ instance: e, id: t }, n));
        })(e, t.id, n);
      },
    ],
    [
      ...
      function (e, t, n) {
        !(function (e, t, n, i) {
          l.sdk.navigateToNewsSubject(o({ instance: e, id: t, title: n }, i));
        })(e, t.id, t.title, n);
      },
    ],
    [
      ...
      function (e, t) {
        !(function (e, t) {
          l.sdk.navigateToLiveCalendar({ instance: e, date: t });
        })(e, t.date);
      },
    ],
    [
    ...
    [
      ...
      function (e, t, n) {
        !(function (e, t, n) {
          l.sdk.navigateToLiveDetail(o({ instance: e, id: t }, n));
        })(e, t.id, n);
      },
    ],
    ...
    [
      ...
      function (e, t, n) {
        !(function (e, t, n, i) {
          l.sdk.navigateToAIFinancialReport(
            o({ instance: e, id: t, title: n }, i)
          );
        })(e, t.id, t.title, n);
      },
    ],
