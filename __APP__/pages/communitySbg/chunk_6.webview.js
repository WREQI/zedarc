$gwx23_XC_6 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var cRX = _n("page-meta");
      _rz(z, cRX, "rootFontSize", 0, e, s, gg);
      _(r, cRX);
      var hSX = _n("view");
...
if (!noCss) {
  __wxAppCode__["pages/communitySbg/index.wxss"] = setCssToHead([], undefined, {
    path: "./pages/communitySbg/index.wxss",
  });
}
