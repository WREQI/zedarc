$gwx35_XC_6 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx35_XC_6 || [];
    function gz$gwx35_XC_6_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx35_XC_6_1)
        return __WXML_GLOBAL__.ops_cached.$gwx35_XC_6_1;
      __WXML_GLOBAL__.ops_cached.$gwx35_XC_6_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx35_XC_6 = z;
    __WXML_GLOBAL__.ops_init.$gwx35_XC_6 = true;
    var x = ["./pages/broker/components/zhongxinjiantou/index.wxml"];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx35_XC_6_1();
      var oBB = _n("view");
...
if (__vd_version_info__.delayedGwx || false) $gwx35_XC_6();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/broker/components/zhongxinjiantou/index.wxml"] = [
    $gwx35_XC_6,
    "./pages/broker/components/zhongxinjiantou/index.wxml",
  ];
else
  __wxAppCode__["pages/broker/components/zhongxinjiantou/index.wxml"] =
    $gwx35_XC_6("./pages/broker/components/zhongxinjiantou/index.wxml");
__wxRoute = "pages/broker/components/zhongxinjiantou/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/broker/components/zhongxinjiantou/index.js";
define(
  "pages/broker/components/zhongxinjiantou/index.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/broker/components/zhongxinjiantou/index.js",
  }
);
require("pages/broker/components/zhongxinjiantou/index.js");
