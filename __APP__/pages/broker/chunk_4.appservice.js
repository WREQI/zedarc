$gwx35_XC_4 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx35_XC_4 || [];
    function gz$gwx35_XC_4_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx35_XC_4_1)
        return __WXML_GLOBAL__.ops_cached.$gwx35_XC_4_1;
      __WXML_GLOBAL__.ops_cached.$gwx35_XC_4_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx35_XC_4 = z;
    __WXML_GLOBAL__.ops_init.$gwx35_XC_4 = true;
    var x = ["./pages/broker/components/zhaoshang/index.wxml"];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx35_XC_4_1();
      var aZ = _n("view");
...
if (__vd_version_info__.delayedGwx || false) $gwx35_XC_4();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/broker/components/zhaoshang/index.wxml"] = [
    $gwx35_XC_4,
    "./pages/broker/components/zhaoshang/index.wxml",
  ];
else
  __wxAppCode__["pages/broker/components/zhaoshang/index.wxml"] = $gwx35_XC_4(
    "./pages/broker/components/zhaoshang/index.wxml"
  );
__wxRoute = "pages/broker/components/zhaoshang/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/broker/components/zhaoshang/index.js";
define(
  "pages/broker/components/zhaoshang/index.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/broker/components/zhaoshang/index.js",
  }
);
require("pages/broker/components/zhaoshang/index.js");
