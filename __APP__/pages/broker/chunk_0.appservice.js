$gwx35_XC_0 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx35_XC_0 || [];
    function gz$gwx35_XC_0_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx35_XC_0_1)
        return __WXML_GLOBAL__.ops_cached.$gwx35_XC_0_1;
      __WXML_GLOBAL__.ops_cached.$gwx35_XC_0_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx35_XC_0 = z;
    __WXML_GLOBAL__.ops_init.$gwx35_XC_0 = true;
    var x = ["./pages/broker/components/guangfa/index.wxml"];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx35_XC_0_1();
      var oB = _n("view");
...
if (__vd_version_info__.delayedGwx || false) $gwx35_XC_0();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/broker/components/guangfa/index.wxml"] = [
    $gwx35_XC_0,
    "./pages/broker/components/guangfa/index.wxml",
  ];
else
  __wxAppCode__["pages/broker/components/guangfa/index.wxml"] = $gwx35_XC_0(
    "./pages/broker/components/guangfa/index.wxml"
  );
__wxRoute = "pages/broker/components/guangfa/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/broker/components/guangfa/index.js";
define(
  "pages/broker/components/guangfa/index.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/broker/components/guangfa/index.js",
  }
);
require("pages/broker/components/guangfa/index.js");
