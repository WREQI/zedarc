$gwx35_XC_3 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx35_XC_3 || [];
    function gz$gwx35_XC_3_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx35_XC_3_1)
        return __WXML_GLOBAL__.ops_cached.$gwx35_XC_3_1;
      __WXML_GLOBAL__.ops_cached.$gwx35_XC_3_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx35_XC_3 = z;
    __WXML_GLOBAL__.ops_init.$gwx35_XC_3 = true;
    var x = ["./pages/broker/components/hualin/index.wxml"];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx35_XC_3_1();
      var cT = _n("view");
...
if (__vd_version_info__.delayedGwx || false) $gwx35_XC_3();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/broker/components/hualin/index.wxml"] = [
    $gwx35_XC_3,
    "./pages/broker/components/hualin/index.wxml",
  ];
else
  __wxAppCode__["pages/broker/components/hualin/index.wxml"] = $gwx35_XC_3(
    "./pages/broker/components/hualin/index.wxml"
  );
__wxRoute = "pages/broker/components/hualin/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/broker/components/hualin/index.js";
define(
  "pages/broker/components/hualin/index.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/broker/components/hualin/index.js",
  }
);
require("pages/broker/components/hualin/index.js");
