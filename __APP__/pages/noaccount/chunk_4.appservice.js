  ...
  return function (path, global) {
    ...
    function gz$gwx2_XC_4_1() {
      ...
      (function (z) {
        ...
        Z([[4], [[5], [1, "d"]]]);
        Z(z[0]);
        Z([3, "2c5d90c4-1,2c5d90c4-0"]);
        Z([[7], [3, "b"]]);
        Z(z[0]);
        Z([3, "2c5d90c4-2,2c5d90c4-0"]);
        Z(z[5]);
      })(__WXML_GLOBAL__.ops_cached.$gwx2_XC_4_1);
      return __WXML_GLOBAL__.ops_cached.$gwx2_XC_4_1;
    }
    ...
    var x = ["./pages/noaccount/index.wxml"];
    d_[x[0]] = {};
...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/noaccount/index.wxml"] = [
    $gwx2_XC_4,
    "./pages/noaccount/index.wxml",
  ];
else
  __wxAppCode__["pages/noaccount/index.wxml"] = $gwx2_XC_4(
    "./pages/noaccount/index.wxml"
  );
__wxRoute = "pages/noaccount/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/noaccount/index.js";
define(
  "pages/noaccount/index.js",
  function (
    require,
    module,
    exports,
  ...
  { isPage: true, isComponent: true, currentFile: "pages/noaccount/index.js" }
);
require("pages/noaccount/index.js");
