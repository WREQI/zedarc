$gwx34_XC_3 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx34_XC_3 || [];
    function gz$gwx34_XC_3_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx34_XC_3_1)
        return __WXML_GLOBAL__.ops_cached.$gwx34_XC_3_1;
      __WXML_GLOBAL__.ops_cached.$gwx34_XC_3_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx34_XC_3 = z;
    __WXML_GLOBAL__.ops_init.$gwx34_XC_3 = true;
    var x = ["./pages/act/investcalendar/detail.wxml"];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx34_XC_3_1();
      var eTB = _v();
      _(r, eTB);
      if (_oz(z, 0, e, s, gg)) {
        eTB.wxVkey = 1;
        ...
        if (_oz(z, 8, e, s, gg)) {
          ...
          var cZB = _mz(
            z,
            "subscribe-guide",
            ["bind:__l", 9, "bindclose", 1, "bindsetting", 2, "uI", 3, "uP", 4],
            [],
            e,
            s,
            gg
...
if (__vd_version_info__.delayedGwx || false) $gwx34_XC_3();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/act/investcalendar/detail.wxml"] = [
    $gwx34_XC_3,
    "./pages/act/investcalendar/detail.wxml",
  ];
else
  __wxAppCode__["pages/act/investcalendar/detail.wxml"] = $gwx34_XC_3(
    "./pages/act/investcalendar/detail.wxml"
  );
__wxRoute = "pages/act/investcalendar/detail";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/act/investcalendar/detail.js";
define(
  "pages/act/investcalendar/detail.js",
  function (
    require,
    module,
    exports,
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 20:
                          if (
                            ((i = e.t0), (r = i.mainSwitch), (s = i.status), r)
                          ) {
                            e.next = 25;
                            break;
                          }
  ...
  },
  {
    isPage: true,
    isComponent: true,
    currentFile: "pages/act/investcalendar/detail.js",
  }
);
require("pages/act/investcalendar/detail.js");
