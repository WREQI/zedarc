      ...
      var p = this,
          ...
          return "searchAi" === n.source
            ? {
                ...
                reportExtra: {
                  ...
                  requestid: null == (r = n.contexObj) ? void 0 : r.requestId,
                },
              }
            : {};
        }),
        ...
        g = function (e) {
          if (
            ...
            return null;
          var r = e.data;
          return k({ latest: r.latest, yysr: r.yysr, jlr: r.jlr, eps: r.eps });
        },
        j = d.useHqCardKit({
          request: function () {
            return (
        ...
        n.cardData
          ? l.e(
              ...
              (n.showViewMore, {}),
              {
                ...
                h: l.o(function () {
                  return (
                    n.handleCardClick && n.handleCardClick.apply(n, arguments)
                  );
                }, 5792),
              }
            )
