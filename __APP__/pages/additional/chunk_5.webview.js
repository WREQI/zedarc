$gwx27_XC_5 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var bMX = _n("page-meta");
      _rz(z, bMX, "rootFontSize", 0, e, s, gg);
      _(r, bMX);
      var oNX = _n("view");
      ...
      if (_oz(z, 4, e, s, gg)) {
        ...
        var fQX = _mz(
          z,
          "zxg-webview",
          ["bind:__l", 5, "bindmessage", 1, "uI", 2, "uP", 3],
          [],
          e,
          s,
          gg
...
if (!noCss) {
  __wxAppCode__["pages/additional/webview/index.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/additional/webview/index.wxss" }
  );
}
