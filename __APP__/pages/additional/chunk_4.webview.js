$gwx27_XC_4 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var hEX = _n("page-meta");
      _rz(z, hEX, "rootFontSize", 0, e, s, gg);
      _(r, hEX);
      var oFX = _n("view");
...
if (!noCss) {
  __wxAppCode__["pages/additional/topicPlaza/topicPlaza.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/additional/topicPlaza/topicPlaza.wxss" }
  );
}
