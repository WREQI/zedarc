$gwx7_XC_5 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      _(r, o0J);
      var lAK = _mz(z, "view", ["class", 2, "data-st-theme", 1], [], e, s, gg);
      var aBK = _mz(
        z,
        "mp-privacy-dialog",
...
if (!noCss) {
  __wxAppCode__["pages/profileCom/history.wxss"] = setCssToHead(
    [
      ".",
      [1],
      "page.",
      [1],
      "data-v-f919c1f9{background:var(--fill-background);min-height:100%}\n",
    ],
    undefined,
    { path: "./pages/profileCom/history.wxss" }
  );
}
