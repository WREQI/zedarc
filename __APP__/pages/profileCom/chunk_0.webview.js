  ...
  return function (path, global) {
    ...
    function gz$gwx7_XC_0_1() {
      ...
      (function (z) {
        ...
        Z([3, "_div banner-img-box data-v-22d1c97b"]);
        Z([[7], [3, "a"]]);
        Z([[7], [3, "c"]]);
        Z([3, "_img banner-img data-v-22d1c97b"]);
        Z([3, "widthFix"]);
        Z([[7], [3, "b"]]);
      })(__WXML_GLOBAL__.ops_cached.$gwx7_XC_0_1);
      return __WXML_GLOBAL__.ops_cached.$gwx7_XC_0_1;
    ...
    var m0 = function (e, s, r, gg) {
      ...
      if (_oz(z, 1, e, s, gg)) {
        ...
        var oD = _mz(
          z,
          "image",
          ["bindtap", 2, "class", 1, "mode", 2, "src", 3],
          [],
          e,
          s,
          gg
...
if (!noCss) {
  __wxAppCode__["pages/profileCom/@tencent/st-act-adv/components/banner.wxss"] =
    setCssToHead(
      [
        ".",
        [1],
        "banner-img-box.",
        [1],
        "data-v-22d1c97b{margin:0 auto .5333333333333333rem;text-align:center}\n.",
        [1],
        "banner-img.",
        [1],
        "data-v-22d1c97b{width:9.2rem}\n",
      ],
      undefined,
      { path: "./pages/profileCom/@tencent/st-act-adv/components/banner.wxss" }
    );
}
