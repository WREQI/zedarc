$gwx18_XC_1 = (function (
  ...
  return function (path, global) {
    ...
    function gz$gwx18_XC_1_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx18_XC_1_1)
    ...
    var x = ["./pages/investment/calendar.wxml"];
    d_[x[0]] = {};
...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/investment/calendar.wxml"] = [
    $gwx18_XC_1,
    "./pages/investment/calendar.wxml",
  ];
else
  __wxAppCode__["pages/investment/calendar.wxml"] = $gwx18_XC_1(
    "./pages/investment/calendar.wxml"
  );
__wxRoute = "pages/investment/calendar";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/investment/calendar.js";
define(
  "pages/investment/calendar.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: true,
    isComponent: true,
    currentFile: "pages/investment/calendar.js",
  }
);
require("pages/investment/calendar.js");
