...
function T(n, i, h) {
  return (
    (function (n, i) {
      if ("々" === n) return i && r.get(i) ? r.get(i).split(" ")[0] : "tóng";
    })(n, i) ||
    (function (n, i) {
        ...
        },
        {
          ...
          value: function (n, i) {
            for (var h = n.length - 1; h >= 0; h--) {
              var g = n[h];
              if (i.priority === g.priority && i.probability >= g.probability)
                n[h + 1] = g;
              else {
              ...
              var h = this,
                ...
                o = function (n) {
                  ...
                  if (null === g) g = h.root;
                    ...
                    var z = (g = g.children.get(o)).patterns.find(function (h) {
                      return "off" === i
                        ? 10 !== h.priority
              ...
              ? (function (n) {
                  for (var i, h, g = [], u = n.length - 1; u >= 0; ) {
                    for (
                      ...
                      o--;
                    (o < 0 || n[o].index + n[o].length <= s) && g.push(n[u]),
                      (u = o);
                  }
                  return g.reverse();
                })(g)
...
var G = new j(),
  ...
  V = function (n) {
    var i =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "off",
      h = G,
...
function tn(n, i) {
  ...
  var h = (function (n, i, h, g) {
    for (var u = W.search(n, h, g), s = 0, o = l(n), z = 0; z < o.length; ) {
      var t = u[s];
      if (t && z === t.index) {
        if (1 === t.length && t.priority <= 1) {
          var y,
            c = o[z];
          (y = T(c, o[z - 1], o[z + 1])),
            (i[z] = { origin: c, result: y, isZh: y !== c, originPinyin: y }),
            z++,
            s++;
          continue;
        }
      ...
      scrollToLetterInMiniProgram: function (n) {
        ...
        h.select(".contact-list").boundingClientRect(),
          ...
          h.exec(function (h) {
            ...
            if (g && u) {
              var o =
                u.top - g.top + ((null == s ? void 0 : s.scrollTop) || 0) - 10;
