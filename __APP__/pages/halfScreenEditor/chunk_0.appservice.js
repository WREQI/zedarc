$gwx49_XC_0 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx49_XC_0 || [];
    function gz$gwx49_XC_0_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx49_XC_0_1)
        return __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_1;
      __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        ...
        Z([3, "g"]);
        Z([[6], [[7], [3, "contact"]], [3, "h"]]);
        Z([3, "_div contact-item data-v-89266d3e"]);
        Z([3, "_div head-img-container data-v-89266d3e"]);
        Z([[6], [[7], [3, "contact"]], [3, "a"]]);
        Z([[6], [[7], [3, "contact"]], [3, "d"]]);
        Z([[6], [[7], [3, "contact"]], [3, "e"]]);
      })(__WXML_GLOBAL__.ops_cached.$gwx49_XC_0_1);
    ...
    function gz$gwx49_XC_0_2() {
      if (__WXML_GLOBAL__.ops_cached.$gwx49_XC_0_2)
        return __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_2;
      __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_2 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        }
        Z([3, "_div stockfriends-list-container data-v-e3c6805b"]);
        Z([[7], [3, "l"]]);
        Z([[7], [3, "a"]]);
        Z([[7], [3, "c"]]);
        Z([3, "__l"]);
        ...
        Z(z[4]);
        Z([[7], [3, "e"]]);
        Z([3, "load-container data-v-e3c6805b"]);
        Z([3, "e3c6805b-1"]);
        Z([[7], [3, "f"]]);
        Z([[7], [3, "g"]]);
        Z([[7], [3, "h"]]);
        ...
        Z([[7], [3, "i"]]);
        Z([[7], [3, "j"]]);
        Z([3, "permissionDialog data-v-e3c6805b"]);
        Z([3, "e3c6805b-2"]);
        Z([[7], [3, "k"]]);
      })(__WXML_GLOBAL__.ops_cached.$gwx49_XC_0_2);
      return __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_2;
    }
    function gz$gwx49_XC_0_3() {
      if (__WXML_GLOBAL__.ops_cached.$gwx49_XC_0_3)
        return __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_3;
      __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_3 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    function gz$gwx49_XC_0_4() {
      if (__WXML_GLOBAL__.ops_cached.$gwx49_XC_0_4)
        return __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_4;
      __WXML_GLOBAL__.ops_cached.$gwx49_XC_0_4 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx49_XC_0 = z;
    __WXML_GLOBAL__.ops_init.$gwx49_XC_0 = true;
    var x = [
      "./pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/ContactList/ContactList.wxml",
      "./pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/stock-friends/index.wxml",
      "./pages/halfScreenEditor/@tencent/stock-halfscreen-editor/pages/stock-friends/index.wxml",
      "./pages/halfScreenEditor/stockFriends/index.wxml",
    ];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx49_XC_0_1();
      var oB = _v();
      _(r, oB);
      var xC = function (fE, oD, cF, gg) {
        ...
        var cI = function (lK, oJ, aL, gg) {
          var eN = _mz(z, "view", ["bindtap", 6, "class", 1], [], lK, oJ, gg);
          var bO = _n("view");
        ...
        oH.wxXCkey = 2;
        _2z(z, 4, cI, fE, oD, gg, oH, "contact", "index", "g");
        return cF;
      };
      oB.wxXCkey = 2;
      _2z(z, 1, xC, e, s, gg, oB, "group", "index", "d");
      return r;
    };
    e_[x[0]] = { f: m0, j: [], i: [], ti: [], ic: [] };
    d_[x[1]] = {};
    var m1 = function (e, s, r, gg) {
      var z = gz$gwx49_XC_0_2();
      ...
      if (_oz(z, 9, e, s, gg)) {
        ...
        var t1 = _mz(
          z,
          "status",
          ["bind:__l", 10, "bindhandleError", 1, "class", 2, "uI", 3, "uP", 4],
          [],
          e,
          s,
          gg
    ...
    var m3 = function (e, s, r, gg) {
      ...
      _(f7, c8);
      var h9 = _mz(z, "stock-friends", ["bind:__l", 3, "uI", 1], [], e, s, gg);
      _(f7, h9);
      _(r, f7);
      return r;
    };
...
if (__vd_version_info__.delayedGwx || false) $gwx49_XC_0();
...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/halfScreenEditor/stockFriends/index.wxml"] = [
    $gwx49_XC_0,
    "./pages/halfScreenEditor/stockFriends/index.wxml",
  ];
else
  __wxAppCode__["pages/halfScreenEditor/stockFriends/index.wxml"] = $gwx49_XC_0(
    "./pages/halfScreenEditor/stockFriends/index.wxml"
  );
__wxRoute =
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/ContactList/ContactList";
__wxRouteBegin = true;
__wxAppCurrentFile__ =
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/ContactList/ContactList.js";
define(
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/ContactList/ContactList.js",
  function (
    require,
    ...
    function c(n) {
      ...
      return (
        n.length -
        ((null === (i = n.match(y)) || void 0 === i ? void 0 : i.length) || 0)
      );
    }
    function l(n) {
      for (var i = [], h = 0; h < n.length; ) {
        var g = n[h];
        z.test(g) && t.test(n[h + 1])
    ...
    var j = (function () {
        function n() {
          u(this, n), (this.NumberDICT = []), (this.StringDICT = new Map());
        }
        return (
          s(n, [
            {
    ...
    var b = [
      ...
      p = (function () {
        ...
        for (var i in w)
          for (var h in q) {
            var g = "".concat(w[i], " ").concat(q[h]);
            n["".concat(i).concat(h)] = g;
          }
        return n;
      })(),
      a = Object.keys(p).map(function (n) {
        return {
          zh: n,
          pinyin: p[n],
          probability: 1e-12,
    ...
    function T(n, i, h) {
      return (
        (function (n, i) {
          if ("々" === n)
            return i && r.get(i) ? r.get(i).split(" ")[0] : "tóng";
        })(n, i) ||
        (function (n, i) {
          if (!("了" !== n || (i && r.get(i)))) return "liǎo";
        })(n, i) ||
        (function (n, i, h) {
          if (-1 === C.indexOf(n)) return J(n);
          if (i === h && i && J(i) !== i) return K(J(n));
          if (h && !v[n].includes(h)) {
            var g = J(h);
            if (g !== h) {
              var u = nn(g),
                s = k[n];
              for (var o in s) if (-1 !== s[o].indexOf(Number(u))) return o;
            }
          }
        })(n, i, h) ||
        J(n)
    ...
    var P,
      ...
      A = Object.keys(Z).map(function (n) {
        return {
          zh: n,
          pinyin: Z[n],
          probability: 1 + c(n),
      ...
      F = Object.keys(M).map(function (n) {
        return {
          zh: n,
          pinyin: M[n],
          probability: 2e-8,
      ...
      D = Object.keys(E).map(function (n) {
        return {
          zh: n,
          pinyin: E[n],
          probability: 2e-8,
      ...
      _ = Object.keys(L).map(function (n) {
        return {
          zh: n,
          pinyin: L[n],
          probability: 2e-8,
    ...
    ((S = P || (P = {}))[(S.ReverseMaxMatch = 1)] = "ReverseMaxMatch"),
      (S[(S.MaxProbability = 2)] = "MaxProbability"),
      (S[(S.MinTokenization = 3)] = "MinTokenization");
    var U = s(function n(i) {
        var h =
      ...
      Q = [].concat(h(_), h(D), h(F), h(O), h(a), h(A)),
      W = new ((function () {
        function n() {
          u(this, n),
            (this.dictMap = new Map()),
            (this.queues = []),
            (this.root = new U(null));
        }
        return (
          s(n, [
            {
            ...
            },
            {
              ...
              value: function (n) {
                ...
                try {
                  for (h.s(); !(i = h.n()).done; ) {
                    for (
                      var u = i.value, s = l(u.zh), o = this.root, z = 0;
                      z < s.length;
                      z++
                    ) {
                      var t = s[z];
                      if (!o.children.has(t)) {
                        var y = new U(o, s.slice(0, z).join(""), t);
                        o.children.set(t, y), this.addNodeToQueues(y);
                      }
                      o = o.children.get(t);
                    }
                    this.insertPattern(o.patterns, u),
                      (u.node = o),
                      this.addPatternToDictMap(u);
                  }
                } catch (n) {
                  h.e(n);
                } finally {
            ...
            },
            {
              ...
              value: function () {
                ...
                for (
                  ...
                  for (
                    var h = n[i++], g = h.parent && h.parent.fail, u = h.key;
                    g && !g.children.has(u);

                  )
                    g = g.fail;
                  h.fail = g ? g.children.get(u) : this.root;
                }
              },
            },
            {
            ...
            },
            {
              key: "addNodeToQueues",
              value: function (n) {
                this.queues[c(n.prefix)] || (this.queues[c(n.prefix)] = []),
                  this.queues[c(n.prefix)].push(n);
              },
            },
            {
              key: "insertPattern",
              value: function (n, i) {
                for (var h = n.length - 1; h >= 0; h--) {
                  ...
                  if (
                    ...
                    i.probability >= g.probability
                  )
                    n[h + 1] = g;
                  else {
                    if (!(i.priority > g.priority)) return void (n[h + 1] = i);
                    n[h + 1] = g;
                  }
                }
                n[0] = i;
            ...
            },
            {
              ...
              value: function (n) {
                this.dictMap.has(n) &&
                  (this.dictMap.get(n).forEach(function (n) {
                    n.node.patterns = n.node.patterns.filter(function (i) {
                      return i !== n;
                    });
                  }),
              ...
              value: function (n, i) {
                for (
                  var h = this,
                    ...
                    s = l(n),
                    o = function (n) {
                      for (var o = s[n]; null !== g && !g.children.has(o); )
                        g = g.fail;
                      if (null === g) g = h.root;
                      else {
                        var z = (g = g.children.get(o)).patterns.find(function (
                          h
                        ) {
                          return "off" === i
                            ? 10 !== h.priority
                            : "head" !== i || h.length - 1 - n == 0;
                        });
                        z &&
                          u.push(
                        ...
                        for (var t = g.fail; null !== t; ) {
                          var y = t.patterns.find(function (h) {
                            return "off" === i
                              ? 10 !== h.priority
                              : "head" !== i || h.length - 1 - n == 0;
                          });
            ...
            },
            {
              ...
              value: function (n, i) {
                ...
                return 1 === h
                  ? (function (n) {
                      for (var i, h, g = [], u = n.length - 1; u >= 0; ) {
                        for (
                          var s = n[u].index, o = u - 1;
                          o >= 0 &&
                          ((i = n[u]),
                          !(
                            (h = n[o]).index + h.length <= i.index ||
                            h.priority > i.priority ||
                            (h.priority === i.priority && h.length > i.length)
                          ));

                        )
                          o--;
                        (o < 0 || n[o].index + n[o].length <= s) &&
                          g.push(n[u]),
                          (u = o);
                      }
                      return g.reverse();
                  ...
                  ? (function (n, i) {
                      for (
                        var h = [], g = n.length - 1, u = n[g], s = i - 1;
                        s >= 0;
                        s--
                      ) {
                        for (
                          var o =
                            s + 1 >= i ? { count: 0, patterns: [] } : h[s + 1];
                          u && u.index + u.length - 1 === s;
                        ...
                        var y = { count: 1 + o.count, patterns: o.patterns };
                        (h[s] = B(h[s], y)),
                          h[s].concatPattern &&
                            ((h[s].patterns = h[s].patterns.concat(
                              h[s].concatPattern
                            )),
    ...
    var G = new j(),
      ...
      X = function (n, i) {
        ...
        try {
          for (z.s(); !(h = z.n()).done; )
            for (var t = h.value, y = 0, c = b; y < c.length; y++) {
              var l = c[y];
              if (t.startsWith(l)) {
                var j = t.slice(l.length);
                -1 !== x.indexOf(l) && -1 !== e.indexOf(j) && (j = f[j]),
                  s.push(l),
                  o.push(j);
                break;
              }
      ...
      on = function (n, i) {
        return (
          ...
          (function (n) {
            ...
            return h.length > 0
              ? h.map(function (i) {
                  return { origin: n, result: i, isZh: !0, originPinyin: i };
                })
    ...
    function tn(n, i) {
      if (
        ((i = Object.assign(Object.assign({}, zn), i || {})),
        !(function (n) {
      ...
      var h = (function (n, i, h, g) {
        for (
          var u = W.search(n, h, g), s = 0, o = l(n), z = 0;
          z < o.length;

        ) {
          var t = u[s];
          if (t && z === t.index) {
            if (1 === t.length && t.priority <= 1) {
              var y,
                c = o[z];
              (y = T(c, o[z - 1], o[z + 1])),
                (i[z] = {
            ...
            for (var j = t.pinyin.split(" "), d = 0, r = 0; r < t.length; r++) {
              var b = l(t.zh);
              (i[z + r] = {
                origin: b[r],
                result: j[d] || "",
            ...
            var x,
              e = o[z];
            (x = T(e, o[z - 1], o[z + 1])),
              (i[z] = { origin: e, result: x, isZh: x !== e, originPinyin: x }),
              z++;
          }
        }
        return { list: i, matches: u };
      })(n, Array(c(n)), i.surname, i.segmentit).list;
      return (
        (h = (function (n, i) {
          var h = i.nonZh;
          if ("removed" === h)
            return n.filter(function (n) {
              return n.isZh || !gn(n.origin, i.nonZhScope);
            });
          if ("consecutive" === h) {
            for (var g = n.length - 2; g >= 0; g--) {
              var u = n[g],
                s = n[g + 1];
              !u.isZh &&
                !s.isZh &&
                gn(u.origin, i.nonZhScope) &&
                gn(s.origin, i.nonZhScope) &&
                ((u.origin += s.origin),
                (u.result += s.result),
                (s.delete = !0));
            }
        ...
        (function (n, i) {
          switch (i.pattern) {
            ...
            case "num":
              n.forEach(function (n) {
                n.result = n.isZh ? nn(n.result) : "";
              });
              break;
            case "initial":
              n.forEach(function (n) {
                n.result = n.isZh ? X(n.result, i.initialPattern).initial : "";
              });
              break;
            case "final":
              n.forEach(function (n) {
                n.result = n.isZh ? X(n.result, i.initialPattern).final : "";
              });
              break;
            case "first":
              n.forEach(function (n) {
            ...
            case "finalHead":
              n.forEach(function (n) {
                n.result = n.isZh ? Y(n.result).head : "";
              });
              break;
            case "finalBody":
              n.forEach(function (n) {
                n.result = n.isZh ? Y(n.result).body : "";
              });
              break;
            case "finalTail":
              n.forEach(function (n) {
                n.result = n.isZh ? Y(n.result).tail : "";
              });
          }
        })(h, i),
        (function (n, i) {
          switch (i.toneType) {
            ...
            case "none":
              n.forEach(function (n) {
                n.isZh && (n.result = K(n.result));
              });
              break;
            case "num":
              n.forEach(function (n) {
                n.isZh &&
                  (n.result = (function (n, i) {
                    var h = K(n).split(" "),
                      g = nn(i).split(" "),
                      u = [];
                    return (
                      h.forEach(function (n, i) {
                        u.push("".concat(n).concat(g[i]));
                      }),
                      u.join(" ")
                    );
          ...
          return "array" === i.type
            ...
            ? n.map(function (n) {
                ...
                return (
                  "" !== h &&
                    (c = [h].concat(
                      V(n.origin, i.surname).filter(function (n) {
                        return n !== h;
                      })
                    )),
                  {
                    ...
                    finalBody: t,
                    finalTail: y,
                    num: Number(nn(n.originPinyin)),
                    isZh: n.isZh,
                    polyphonic: c,
                    inZhRange: !!r.get(n.origin),
                    result: n.result,
                  }
                );
              })
    ...
    ((sn = un || (un = {}))[(sn.AllSegment = 1)] = "AllSegment"),
      (sn[(sn.AllArray = 2)] = "AllArray"),
      (sn[(sn.AllString = 3)] = "AllString"),
      (sn[(sn.PinyinSegment = 4)] = "PinyinSegment"),
      (sn[(sn.PinyinArray = 5)] = "PinyinArray"),
      (sn[(sn.PinyinString = 6)] = "PinyinString"),
      (sn[(sn.ZhSegment = 7)] = "ZhSegment"),
      (sn[(sn.ZhArray = 8)] = "ZhArray"),
      (sn[(sn.ZhString = 9)] = "ZhString"),
      un.AllSegment;
    var yn = {
        name: "ContactList",
        props: {
        ...
        emits: ["contact-click"],
        data: function () {
          return { currentLetter: "", scrollTop: 0, oldScrollTop: 0 };
        },
        computed: {
          alphabetList: function () {
            var n = this.sortedContacts.map(function (n) {
              return n.letter;
            });
            return [
              "A",
          ...
          sortedContacts: function () {
            ...
            return (
              this.topList &&
                ...
                ((i.AI = h(this.topList)),
                i.AI.sort(function (i, h) {
                  return n.sortFn
                    ? n.sortFn(i, h)
                    : i.user_name.localeCompare(h.user_name, "zh-CN");
                })),
              this.contacts &&
                this.contacts.length > 0 &&
                (this.contacts.forEach(function (h) {
                  var g = n.getFirstLetter(h.user_name);
                  i[g] || (i[g] = []), i[g].push(h);
                }),
                Object.keys(i).forEach(function (h) {
                  "AI" !== h &&
                    i[h].sort(function (i, h) {
                      return n.sortFn
                        ? n.sortFn(i, h)
                        : i.user_name.localeCompare(h.user_name, "zh-CN");
                    });
        ...
        mounted: function () {},
        methods: {
          getFirstLetter: function (n) {
            if (!n) return "#";
            var i = n.charAt(0).toUpperCase();
            if (/^[A-Z]$/.test(i)) return i;
            var h = this.getPinyinFirstLetter(i);
            return h && /^[A-Z]$/.test(h) ? h : "#";
          },
          getPinyinFirstLetter: function (n) {
            if (!n) return "#";
            try {
              var i = tn(n, { pattern: "first", toneType: "none" });
              if (i) {
                var h = i.charAt(0).toUpperCase();
                if (/^[A-Z]$/.test(h)) return h;
              }
            } catch (n) {}
            return "#";
          },
          handleContactClick: function (n) {
            this.$emit("contact-click", n);
          },
          scrollToLetter: function (n) {
            if (
              this.sortedContacts.find(function (i) {
                return i.letter === n;
              })
            )
              try {
                this.scrollToLetterInMiniProgram(n);
              } catch (n) {}
          },
          scrollToLetterInMiniProgram: function (n) {
            var i = this,
              h = o.index.createSelectorQuery().in(this);
            h.select(".contact-list").boundingClientRect(),
              h.select("#group-".concat(n)).boundingClientRect(),
              h.select(".contact-list").scrollOffset(),
              h.exec(function (h) {
                var g = h[0],
                  u = h[1],
                  s = h[2];
                if (g && u) {
                  var o =
                    u.top -
                    g.top +
                    ((null == s ? void 0 : s.scrollTop) || 0) -
                    10;
                  i.performScrollInMiniProgram(o), (i.currentLetter = n);
                }
              });
          },
          scrollToLetterInH5: function (n) {
            var i = this.$refs.contactList;
            if (i) {
              var h = i.$el || i;
              if (h && h.getBoundingClientRect) {
                var g = document.getElementById("group-".concat(n));
                if (g) {
                  var u = h.getBoundingClientRect(),
                    s = g.getBoundingClientRect(),
                    o = this.calculateScrollOffset(s.top, u.top, h.scrollTop);
                  this.performScrollInH5(h, o), (this.currentLetter = n);
                }
              }
            }
          },
          calculateScrollOffset: function (n, i, h) {
            return n - i + h - 10;
          },
          performScrollInMiniProgram: function (n) {
            var i = this;
          ...
          performScrollInH5: function (n, i) {
            n.scrollTo
      ...
      cn = o._export_sfc(yn, [
        [
          "render",
          function (n, i, h, g, u, s) {
            return {
              a: o.f(s.sortedContacts, function (n, i, h) {
                return {
                  a: o.t("AI" === n.letter ? "AI好友" : n.letter),
                  b: "group-".concat(n.letter),
                  c: o.f(n.contacts, function (n, i, h) {
                    return o.e(
                      { a: n.user_image },
                      n.user_image ? { b: n.user_image, c: n.user_name } : {},
                      { d: 1001 === n.vip_type },
                      (n.vip_type, {}),
                      { e: 1002 === n.vip_type },
                      (n.vip_type, {}),
                  ...
                  d: "".concat(n.letter, "-").concat(i),
                };
              }),
              b: u.scrollTop,
              c: o.f(s.alphabetList, function (n, i, h) {
                return {
                  a: o.t(n),
                  b: n,
                  c: o.n({ active: u.currentLetter === n }),
                  d: n,
                  e: o.o(
                    function (i) {
                      return s.scrollToLetter(n);
                    },
                    3063,
                    n
                  ),
        ...
        ["__scopeId", "data-v-89266d3e"],
      ]);
    wx.createComponent(cn);
  },
  {
    isPage: false,
    isComponent: true,
...
require("pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/ContactList/ContactList.js");
__wxRoute =
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/stock-friends/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ =
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/stock-friends/index.js";
define(
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/stock-friends/index.js",
  function (
    require,
...
require("pages/halfScreenEditor/@tencent/stock-halfscreen-editor/components/stock-friends/index.js");
__wxRoute =
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/pages/stock-friends/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ =
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/pages/stock-friends/index.js";
define(
  "pages/halfScreenEditor/@tencent/stock-halfscreen-editor/pages/stock-friends/index.js",
  function (
    require,
    ...
    var e = require("../../../../../../@babel/runtime/helpers/createForOfIteratorHelper"),
      ...
      i = {
        ...
        setup: function () {
          ...
          try {
            var u =
              null == (r = a.wx$1) ? void 0 : r.getStorageSync("user/skin");
            u && (o.value = u);
          } catch (e) {}
          return (
...
require("pages/halfScreenEditor/@tencent/stock-halfscreen-editor/pages/stock-friends/index.js");
__wxRoute = "pages/halfScreenEditor/stockFriends/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/halfScreenEditor/stockFriends/index.js";
define(
  "pages/halfScreenEditor/stockFriends/index.js",
  function (
    require,
    module,
    exports,
    ...
    Array ||
      (
        ...
        n.resolveComponent("StockFriends")
      )();
  ...
  },
  {
    isPage: true,
    isComponent: true,
    currentFile: "pages/halfScreenEditor/stockFriends/index.js",
  }
);
require("pages/halfScreenEditor/stockFriends/index.js");
