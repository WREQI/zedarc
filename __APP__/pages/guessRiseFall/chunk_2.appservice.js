$gwx30_XC_2 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx30_XC_2 || [];
    function gz$gwx30_XC_2_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx30_XC_2_1)
        return __WXML_GLOBAL__.ops_cached.$gwx30_XC_2_1;
      __WXML_GLOBAL__.ops_cached.$gwx30_XC_2_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        ...
        Z([3, "data-v-8736b962"]);
        Z([3, "true"]);
        Z([3, "_div guess-guest data-v-8736b962"]);
        Z([[7], [3, "a"]]);
        Z([3, "_div guess-guest__invite-box data-v-8736b962"]);
        Z([[7], [3, "d"]]);
        Z([[7], [3, "f"]]);
        Z([[7], [3, "k"]]);
        Z([3, "__l"]);
        ...
        Z(z[8]);
        Z([[7], [3, "y"]]);
        Z([3, "guess-guest__ai-entry data-v-8736b962"]);
        Z([3, "8736b962-4"]);
        Z([[7], [3, "z"]]);
        Z(z[8]);
        Z([[7], [3, "B"]]);
    ...
    function gz$gwx30_XC_2_2() {
      if (__WXML_GLOBAL__.ops_cached.$gwx30_XC_2_2)
        return __WXML_GLOBAL__.ops_cached.$gwx30_XC_2_2;
      __WXML_GLOBAL__.ops_cached.$gwx30_XC_2_2 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        }
        Z([3, "_div guess-rise-fall-guest data-v-60ed7b5e"]);
        Z([3, "__l"]);
        Z([3, "data-v-60ed7b5e"]);
        Z([3, "60ed7b5e-0"]);
        Z(z[1]);
    ...
    __WXML_GLOBAL__.ops_set.$gwx30_XC_2 = z;
    __WXML_GLOBAL__.ops_init.$gwx30_XC_2 = true;
    var x = [
      "./pages/guessRiseFall/@tencent/st-act-guessrisefall/src/pages/share/mp.wxml",
      "./pages/guessRiseFall/guest/main.wxml",
    ];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx30_XC_2_1();
      var eNH = _mz(z, "scroll-view", ["class", 0, "scrollY", 1], [], e, s, gg);
      var oPH = _n("view");
      ...
      var o4H = _mz(
        z,
        "reward-modal",
        ["bind:__l", 40, "bindcontinue", 1, "class", 2, "uI", 3, "uR", 4],
        [],
        e,
        s,
        gg
    ...
    var m1 = function (e, s, r, gg) {
      ...
      if (_oz(z, 7, e, s, gg)) {
        ...
        var o0H = _mz(
          z,
          "guest-page",
          ["bind:__l", 8, "class", 1, "uI", 2, "uP", 3, "uR", 4],
          [],
          e,
          s,
          gg
...
if (__vd_version_info__.delayedGwx || false) $gwx30_XC_2();
...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/guessRiseFall/guest/main.wxml"] = [
    $gwx30_XC_2,
    "./pages/guessRiseFall/guest/main.wxml",
  ];
else
  __wxAppCode__["pages/guessRiseFall/guest/main.wxml"] = $gwx30_XC_2(
    "./pages/guessRiseFall/guest/main.wxml"
  );
__wxRoute =
  "pages/guessRiseFall/@tencent/st-act-guessrisefall/src/pages/share/mp";
__wxRouteBegin = true;
__wxAppCurrentFile__ =
  "pages/guessRiseFall/@tencent/st-act-guessrisefall/src/pages/share/mp.js";
define(
  "pages/guessRiseFall/@tencent/st-act-guessrisefall/src/pages/share/mp.js",
  function (
    require,
                          ...
                          case 0:
                            return (
                              ...
                              (this.aiDialogQuestion = e.ai_question
                                ...
                                : ""),
                              (n =
                                d.StockBridge.getStorage("guess_home_cache")),
                              (r =
                                d.StockBridge.getStorage("guess_stock_cache")),
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 5:
                            return (
                              (r = e.sent),
                              (e.next = 8),
                              p.CommentParser(r.data)
                            );
                          case 8:
                            (s = e.sent),
                              this.applyOpinionData(s),
                              (e.next = 14);
                            break;
                          case 12:
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.prev = 0), (e.next = 3), p.fetchStockInfo()
                            );
                          case 3:
                            return (
                              (t = e.sent),
              ...
              "0" !== e
                ? ((this.modalOptions = {
                  ...
                  d.StockBridge.report(
                    "yy.czdlanew.guest_error_pupon_baoguang",
                    { yy_public_str1: e }
                  ))
                : this.inviteCode &&
...
require("pages/guessRiseFall/@tencent/st-act-guessrisefall/src/pages/share/mp.js");
__wxRoute = "pages/guessRiseFall/guest/main";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/guessRiseFall/guest/main.js";
define(
  "pages/guessRiseFall/guest/main.js",
  function (
    require,
    module,
    exports,
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        ...
                        return (
                          (e.next = 3), this.$refs.guestPage.getShareConfig()
                        );
                      case 3:
            ...
            new Promise(function (e, r) {
              var s = function (e) {
                ...
                a = function (t) {
                  return t.done
                    ? e(t.value)
                    : Promise.resolve(t.value).then(s, o);
                };
  ...
  },
  {
    isPage: true,
    isComponent: true,
    currentFile: "pages/guessRiseFall/guest/main.js",
  }
);
require("pages/guessRiseFall/guest/main.js");
