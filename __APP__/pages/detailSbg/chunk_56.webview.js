$gwx3_XC_52 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      _(r, bKNF);
      var oLNF = _mz(z, "view", ["class", 2, "data-st-theme", 1], [], e, s, gg);
      var fONF = _mz(
        z,
        "mp-privacy-dialog",
...
if (!noCss) {
  __wxAppCode__["pages/detailSbg/klineSetting.wxss"] = setCssToHead(
    [
      ".",
      [1],
      "kline-setting-container.",
      [1],
      "data-v-49c97c5e{background-color:var(--color-card);height:100%}\n",
    ],
    undefined,
    { path: "./pages/detailSbg/klineSetting.wxss" }
  );
}
