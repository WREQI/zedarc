$gwx3_XC_48 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      _(r, tQMF);
      var eRMF = _mz(z, "view", ["class", 2, "data-st-theme", 1], [], e, s, gg);
      var xUMF = _mz(
        z,
        "mp-privacy-dialog",
...
if (!noCss) {
  __wxAppCode__["pages/detailSbg/chartSettingParams.wxss"] = setCssToHead(
    [
      ".",
      [1],
      "chart-params-container.",
      [1],
      "data-v-04d494a3{background-color:var(--color-card);height:100%}\n",
    ],
    undefined,
    { path: "./pages/detailSbg/chartSettingParams.wxss" }
  );
}
