  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var oDNF = _mz(
        z,
        "view",
        ["class", 2, "data-st-theme", 1, "skin", 2],
        [],
        e,
        s,
        gg
...
if (!noCss) {
  __wxAppCode__["pages/detailSbg/jgrate.wxss"] = setCssToHead(
    [
      ".",
      [1],
      "rate-page-outter.",
      [1],
      "data-v-889cb18d{height:100%;width:100%}\n",
    ],
    undefined,
    { path: "./pages/detailSbg/jgrate.wxss" }
  );
}
