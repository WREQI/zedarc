    ...
    return (
      (r.renderLabels = function () {
        ...
        l.forEach(function (t) {
          var r = t._attrs.attrs,
            ...
            w = { x: 0, y: 0, fontSize: 12, lineHeight: 12, fill: "#808080" };
          (0, a.isFunction)(f) &&
            S.addShape("Text", {
        ...
        var _ = [];
        if (g)
          for (var S, w = c[1].concat(c[0]), E = 0, I = w.length; E < I; E++) {
            var L = w[E],
              C = t._drawLabel(L);
            (S && o(C, S)) ||
      ...
      (r._drawLabelLine = function (t, e) {
        ...
        if (!u && d.y !== g)
          if (d.y < g) {
            var y = d,
              x = { x: "left" === t._side ? v.x + e + c : v.x - e - c, y: d.y },
        ...
        for (p - u > d && (d = p - u); f; )
          for (
            m.forEach(function (t) {
              var e =
                (Math.min.apply(g, t.targets) + Math.max.apply(g, t.targets)) /
                2;
