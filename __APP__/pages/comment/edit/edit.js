            ...
            (function (e) {
              if (e && 0 !== e.length) {
                var t = (1 === e.length &&
                  ...
                  })(e[0])) || { width: 224, height: 224, mode: "aspectFill" };
  ...
  q = {
    ...
    onLoad: function (e) {
      ...
      Object.keys($).forEach(function (e) {
        ...
        h.wx$1.hideShareMenu({ menus: ["shareAppMessage", "shareTimeline"] }),
        I(this.query);
    },
    onUnload: function () {
    ...
    computed: {
      submitButtonColor: function () {
        return this.displayText || this.previewImages.length || this.hasInput
          ? ""
          : "grey";
      },
      opCount: function () {
    ...
    methods: {
      ...
      bindblur: function (e) {
        var t = null != this.displayText ? this.displayText : e.detail.value,
      ...
      bindinpute: function (e) {
        ...
        (this.hasInput = "" != t), (this.cursor = n), (this.displayText = t);
      },
      showEmoji: function () {
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 3:
                      return (
                        ...
                        (r = o.mpVersion),
                        (a =
                          (h.wx$1.getDeviceInfo && h.wx$1.getDeviceInfo()) ||
              ...
              if ("detail" === c) {
                ...
                f &&
                  ...
                  ((T = p(l({}, O), {
                    ...
                    {
                      title: "【视频】".concat(_),
                      data: { hyperHybirdUrl: j, hyperH5Url: E, wxMiniUrl: C },
                      type: "hyper",
                    },
                  ]));
              } else {
                    ...
                    case 11:
                      (s = this.handleText()),
                        ...
                        n.previewImages.forEach(function (e, t) {
                          y.push({ origin: e, filesize: "", origin_prop: "" });
                        }),
                        (w = {
                          comment: [
                            {
                              ...
                              h.Request.getWxUserInfo().then(function (t) {
                                if (t) {
                                  ...
                                  (n.fake_id = b),
                                    ...
                                    (n.type2 = d),
                                    (n.from_user =
                                      h.wx$1.getStorageSync("userinfo").openid);
                                  var o =
                                    "detail" == p ? "newComment" : "newSubject";
                                  i.emit(o, { post: n }),
                                    ...
                                    I.postComment(t, p).then(function (e) {
                                      ...
                                      i.emit(r, a),
                                        ...
                                        e &&
                                          ...
                                          setTimeout(function () {
                                            h.wx$1.navigateBack({ delta: 1 });
                                            var e = I.getOpenerEventChannel();
                                            e &&
                                              e.emit &&
                                              e.emit("navigateBack", {
                                                page: "info_detail",
                ...
                ? h.e(
                    ...
                    e.previewImages.length < 9
                      ? {
                          q: h.o(function () {
                            return (
                              e.chooseImage && e.chooseImage.apply(e, arguments)
                            );
                          }, 352),
                        }
                      : {}
                ...
                return {
                  a: h.f(t.list, function (t, n, i) {
                    return {
                      a: h.o(
                        function () {
                          return e.tapEmoji && e.tapEmoji.apply(e, arguments);
                        },
                        357,
                        n
                      ),
