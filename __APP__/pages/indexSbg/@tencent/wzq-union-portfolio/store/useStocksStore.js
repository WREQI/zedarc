...
var t = require("../../../../../@babel/runtime/helpers/toConsumableArray"),
  ...
  h = require("../../../../indexSbg/@tencent/stock-hq-data/index.js"),
  b = function (e, t) {
    ...
    for (
      var z = function () {
          ...
          if (o.id === p.STOCKBASKET_GROUPID) {
            var S = d.list && d.list.length ? d.list : f;
            (l[o.id] = { list: S, len: S.length, hkstocklen: 0 }),
              o && i.push(o);
          } else {
    ...
    var n,
      ...
      K = v(
        ...
        ((n = {
          ...
          name: _((h || "").replace(/%/g, "%25")),
          marketIcon: S.transMarket(o, w, q, P),
          delay: 0,
          usable: u || j,
          scode: q,
          trimedCode: S.trimScode(q || b),
          market: o,
          type: w,
          stock_type: P,
          zjcj: "KJ-HB" === c ? z : g,
    ...
    var t,
      r =
        arguments.length > 1 && void 0 !== arguments[1]
          ? arguments[1]
          : "rise_per",
      a = p.eq(e.susp_flag, S.STOCK_STATE_SUSPEND) ? e.susp_flag : e.status;
    return C(a)
  ...
  j = function (e, t, r) {
    if (p.eq(e.susp_flag, S.STOCK_STATE_SUSPEND) || C(e.status))
      return "bg-peace";
  ...
  R = function (e, t) {
    var r = p.eq(e.susp_flag, S.STOCK_STATE_SUSPEND) ? e.susp_flag : e.status;
    return !C(r) && "—" !== t;
  },
  M = null,
  L = null,
  x = d.defineStore("useStocksStore", function () {
    ...
    var l = d.ref(i),
      ...
      G = function (e, t) {
        ...
        !e &&
          ...
          l.value.forEach(function (e, t) {
            (1 != +e.type && "全部" !== e.name) ||
              ((h.value = e.id), (O.value = t), (g.value = e.id));
          }),
          "number" == typeof t &&
            ((O.value = t),
            (e && e.id) ||
      ...
      W = function (e, t, i) {
        var l;
        if (e && e.length) {
          var o = (null == (l = n.value[t || h]) ? void 0 : l.list) || [],
            s = new Map();
          ...
          u.value[t || h] !== f && Object.assign(u.value, r({}, t || h, f));
        }
      },
      Y = function (e, t) {
            ...
            if (i && i.length) {
              var l = i.findIndex(function (t) {
                  return void 0 !== e.chooseSymbol
                    ? S.hackUSSymbol(S.trimScode(t.chooseSymbol)) ===
                        S.hackUSSymbol(e.chooseSymbol)
...
(exports.formatDataFromPosition = function (e) {
  return e.map(function (e, t) {
    return v(f({}, e), {
      ...
      riseDropStyle: j(e),
      priceVal: m(e),
      trimedCode: S.trimScode(e.scode),
    ...
    if (!C(a)) {
      ...
      if (t) {
        try {
          var u = l[i];
          n =
            S.isUSMarket(u) || h.utils.isFTIndex(u)
              ? r[54]
              : S.isHKMarket(u)
              ? r[61]
              : S.isHSPlate(u)
