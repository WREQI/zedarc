  ...
  return function (path, global) {
    ...
    function gz$gwx50_XC_1_1() {
      ...
      (function (z) {
        ...
        Z([[7], [3, "a"]]);
        Z([[7], [3, "b"]]);
        Z([3, "_div ai-entry-tiny"]);
        Z([3, ""]);
        Z([3, "_img ai-img"]);
        Z([
          3,
          "https://st.gtimg.com/design/7ad9f07a0ca7d7a6ca677d83f75ddf21.png",
        ]);
      })(__WXML_GLOBAL__.ops_cached.$gwx50_XC_1_1);
      return __WXML_GLOBAL__.ops_cached.$gwx50_XC_1_1;
    }
    ...
    var m0 = function (e, s, r, gg) {
      ...
      if (_oz(z, 0, e, s, gg)) {
        b3.wxVkey = 1;
        var o4 = _mz(z, "view", ["catchtap", 1, "class", 1], [], e, s, gg);
        var x5 = _mz(
          z,
          "image",
          ["alt", 3, "class", 1, "src", 2],
...
if (!noCss) {
  __wxAppCode__["pages/indexSbg/@tencent/stock-ai-entry-tiny/index.wxss"] =
    setCssToHead(
      [
        ".",
        [1],
        "ai-entry-tiny{margin-left:.05333333333333334rem;margin-right:.16rem}\n.",
        [1],
        "ai-img{display:block;height:.64rem;width:.8rem}\n",
      ],
      undefined,
      { path: "./pages/indexSbg/@tencent/stock-ai-entry-tiny/index.wxss" }
    );
}
