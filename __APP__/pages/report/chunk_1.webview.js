...
if (!noCss) {
  __wxAppCode__["pages/report/AIFinancial/list.wxss"] = setCssToHead(
    [
      ".",
      [1],
      "financial-report-wrapper.",
      [1],
      "data-v-6e484b4b{background-color:#f5f6fa;padding-bottom:env(safe-area-inset-bottom)!important}\n",
    ],
    undefined,
    { path: "./pages/report/AIFinancial/list.wxss" }
  );
}
