$gwx16_XC_3 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx16_XC_3 || [];
    function gz$gwx16_XC_3_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx16_XC_3_1)
        return __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_1;
      __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    function gz$gwx16_XC_3_2() {
      if (__WXML_GLOBAL__.ops_cached.$gwx16_XC_3_2)
        return __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_2;
      __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_2 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    function gz$gwx16_XC_3_3() {
      if (__WXML_GLOBAL__.ops_cached.$gwx16_XC_3_3)
        return __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_3;
      __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_3 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        ...
        Z([[7], [3, "f"]]);
        Z([[7], [3, "g"]]);
        Z([3, "r data-v-cc828023"]);
        Z([3, "morningReportCard"]);
        Z([3, "cc828023-3"]);
        Z([[7], [3, "h"]]);
        Z(z[19]);
        Z([[7], [3, "i"]]);
        ...
        Z(z[3]);
        Z([[7], [3, "x"]]);
        Z([3, "share-layer data-v-cc828023"]);
        Z([3, "cc828023-6"]);
        Z([[7], [3, "y"]]);
        Z([[7], [3, "z"]]);
        Z(z[3]);
    ...
    function gz$gwx16_XC_3_4() {
      if (__WXML_GLOBAL__.ops_cached.$gwx16_XC_3_4)
        return __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_4;
      __WXML_GLOBAL__.ops_cached.$gwx16_XC_3_4 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
    ...
    __WXML_GLOBAL__.ops_set.$gwx16_XC_3 = z;
    __WXML_GLOBAL__.ops_init.$gwx16_XC_3 = true;
    var x = [
      "./pages/report/components/navBar.wxml",
      "./pages/report/components/shareLayer.wxml",
      "./pages/report/morning/main.wxml",
      "./pages/report/morning/skeleton/skeleton.wxml",
    ];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx16_XC_3_1();
      return r;
    };
    e_[x[0]] = { f: m0, j: [], i: [], ti: [], ic: [] };
    d_[x[1]] = {};
    var m1 = function (e, s, r, gg) {
      var z = gz$gwx16_XC_3_2();
      return r;
    };
    e_[x[1]] = { f: m1, j: [], i: [], ti: [], ic: [] };
    d_[x[2]] = {};
    var m2 = function (e, s, r, gg) {
      var z = gz$gwx16_XC_3_3();
      var cW = _mz(
        z,
        "view",
        ["bindtap", 0, "class", 1, "data-st-theme", 1],
        [],
        e,
        s,
        gg
      ...
      if (_oz(z, 23, e, s, gg)) {
        ...
        var eFB = _mz(
          z,
          "morning-report-com-list",
          [
            "bind:__l",
            24,
            "bindcomListDataReady",
            1,
            "bindcommentReport",
            2,
            "bindgoEdit",
      ...
      if (_oz(z, 35, e, s, gg)) {
        ...
        var bGB = _mz(
          z,
          "navigator-bar",
          ["bind:__l", 36, "class", 1, "id", 2, "uI", 3, "uP", 4],
          [],
          e,
          s,
          gg
      ...
      if (_oz(z, 41, e, s, gg)) {
        ...
        var oHB = _mz(
          z,
          "share-layer",
          ["bind:__l", 42, "bindhidden", 1, "class", 2, "uI", 3],
          [],
          e,
          s,
          gg
...
if (__vd_version_info__.delayedGwx || false) $gwx16_XC_3();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/report/components/navBar.wxml"] = [
    $gwx16_XC_3,
    "./pages/report/components/navBar.wxml",
  ];
else
  __wxAppCode__["pages/report/components/navBar.wxml"] = $gwx16_XC_3(
    "./pages/report/components/navBar.wxml"
  );
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/report/components/shareLayer.wxml"] = [
    $gwx16_XC_3,
    "./pages/report/components/shareLayer.wxml",
  ];
else
  __wxAppCode__["pages/report/components/shareLayer.wxml"] = $gwx16_XC_3(
    "./pages/report/components/shareLayer.wxml"
  );
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/report/morning/main.wxml"] = [
    $gwx16_XC_3,
    "./pages/report/morning/main.wxml",
  ];
else
  __wxAppCode__["pages/report/morning/main.wxml"] = $gwx16_XC_3(
    "./pages/report/morning/main.wxml"
  );
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/report/morning/skeleton/skeleton.wxml"] = [
    $gwx16_XC_3,
    "./pages/report/morning/skeleton/skeleton.wxml",
  ];
else
  __wxAppCode__["pages/report/morning/skeleton/skeleton.wxml"] = $gwx16_XC_3(
    "./pages/report/morning/skeleton/skeleton.wxml"
  );
__wxRoute = "pages/report/components/navBar";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/report/components/navBar.js";
define(
  "pages/report/components/navBar.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/report/components/navBar.js",
  }
);
require("pages/report/components/navBar.js");
__wxRoute = "pages/report/components/shareLayer";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/report/components/shareLayer.js";
define(
  "pages/report/components/shareLayer.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/report/components/shareLayer.js",
  }
);
require("pages/report/components/shareLayer.js");
__wxRoute = "pages/report/morning/skeleton/skeleton";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/report/morning/skeleton/skeleton.js";
define(
  "pages/report/morning/skeleton/skeleton.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/report/morning/skeleton/skeleton.js",
  }
);
require("pages/report/morning/skeleton/skeleton.js");
__wxRoute = "pages/report/morning/main";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/report/morning/main.js";
define(
  "pages/report/morning/main.js",
  function (
    require,
    module,
    exports,
    ...
    var e = require("../../../@babel/runtime/helpers/regeneratorRuntime"),
      ...
      k = function (e) {
        ...
        return d(c({}, f), {
          code: Number(
            null != (s = null != (i = e.code) ? i : e.retcode) ? s : -1
          ),
          msg: String(
            null != (l = null != (a = e.msg) ? a : e.retmsg) ? l : ""
          ),
      ...
      N = {
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 17:
                        return (
                          (e.prev = 17), p.wx$1.hideLoading(), e.finish(17)
                        );
                      case 20:
        ...
        onShow: function () {
          ...
          (this.needRefreshComList || this.needRefreshComListAll) &&
            (this.updateComList({
              refreshTapPostion: !this.needRefreshComListAll,
            }),
              ...
              p.nextTick$1(function () {
                ...
                try {
                  e.needRefreshSnpData &&
                    ...
                    null ==
                      (n =
                        null == (t = e.$refs) ? void 0 : t.morningReportCard) ||
                      n.requestStockIsInPortfolio()),
                    null ==
                      (o =
                        null == (r = e.$refs) ? void 0 : r.morningReportCard) ||
                      o.mpOnShow();
                } catch (e) {}
              }),
        ...
        onReachBottom: function () {
          ...
          this.comListDataReady &&
            p.nextTick$1(function () {
              ...
              try {
                null ==
                  (n = null == (t = e.$refs) ? void 0 : t.morningComList) ||
                  n.mpOnLoadMore();
              } catch (e) {}
            });
        },
        ...
        methods: {
                        ...
                        case 19:
                          return (
                            ...
                            this.userinfo &&
                              ...
                              (s =
                                d.length > 0 ? "&".concat(d.join("&")) : "")),
                            (h = ""
                              .concat(t, "?filter=0&news_id=")
                              .concat(this.newsId, "&")
                              .concat(i.queryStr, "&reserve=")
                              .concat(
                                parseInt("101011110110000000000010010011", 2)
                              )
                              .concat(s)),
                            (n.next = 25),
          ...
          updateComList: function () {
            ...
            setTimeout(function () {
              ...
              try {
                null ==
                  (r = null == (n = e.$refs) ? void 0 : n.morningComList) ||
                  r.updateComList(t);
              } catch (e) {}
            }, 300);
          },
  ...
  },
  {
    isPage: true,
    isComponent: true,
    currentFile: "pages/report/morning/main.js",
  }
);
require("pages/report/morning/main.js");
