                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.prev = 0),
                        (e.next = 3),
                        r.requestMessageBoxListComment("", m.value)
                      );
                    case 3:
                    ...
                    case 7:
                      (o = e.sent),
                        ...
                        (l.value = !0),
                        c("refreshSuccess", { data: n, hasMore: f.value }),
                        (e.next = 13);
                      break;
                    case 12:
                      c("refreshFail");
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        return (
                          (t.prev = 1),
                          (t.next = 4),
                          r.requestMessageBoxListComment(p.value, m.value)
                        );
                      case 4:
                      ...
                      case 8:
                        (u = t.sent),
                          ...
                          c("loadMoreSuccess", { data: o, hasMore: f.value });
                      case 11:
                        t.next = 16;
                        break;
                      case 13:
          ...
          ? {
              b: n.f(r.listData, function (e, t, a) {
                return {
                  a: "b16ac697-0-" + a,
                  b: n.p({
                    "report-prefix": o.PageType.COMMENT,
                    "item-index": t,
                    "item-data": e,
                    "item-type": o.IteractionItemType.COMMENT,
                  }),
                  c: t,
                };
              }),
