$gwx5_XC_4 = (function (
  ...
  return function (path, global) {
    ...
    function gz$gwx5_XC_4_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx5_XC_4_1)
    ...
    var x = ["./pages/market/pages/ETFRankPage.wxml"];
    d_[x[0]] = {};
...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/market/pages/ETFRankPage.wxml"] = [
    $gwx5_XC_4,
    "./pages/market/pages/ETFRankPage.wxml",
  ];
else
  __wxAppCode__["pages/market/pages/ETFRankPage.wxml"] = $gwx5_XC_4(
    "./pages/market/pages/ETFRankPage.wxml"
  );
__wxRoute = "pages/market/pages/ETFRankPage";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/market/pages/ETFRankPage.js";
define(
  "pages/market/pages/ETFRankPage.js",
  function (
    require,
    module,
    exports,
  ...
  },
  {
    isPage: true,
    isComponent: true,
    currentFile: "pages/market/pages/ETFRankPage.js",
  }
);
require("pages/market/pages/ETFRankPage.js");
