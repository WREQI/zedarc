$gwx5_XC_2 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var t5JB = _n("page-meta");
      _rz(z, t5JB, "rootFontSize", 0, e, s, gg);
      _(r, t5JB);
      var e6JB = _mz(
        z,
        "global-market-page",
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/ETFPage/globalMarket.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/ETFPage/globalMarket.wxss" }
  );
}
