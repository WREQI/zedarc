$gwx5_XC_19 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var bUOB = _n("page-meta");
      _rz(z, bUOB, "rootFontSize", 0, e, s, gg);
      _(r, bUOB);
      var oVOB = _mz(
        z,
        "global-invest-home-page",
        ["bind:__l", 1, "class", 1, "uI", 2, "uR", 3],
        [],
        e,
        s,
        gg
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/ETFPage/globalInvest.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/ETFPage/globalInvest.wxss" }
  );
}
