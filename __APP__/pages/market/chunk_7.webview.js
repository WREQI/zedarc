$gwx5_XC_17 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var oHOB = _n("page-meta");
      _rz(z, oHOB, "rootFontSize", 0, e, s, gg);
      _(r, oHOB);
      var eFOB = _v();
      _(r, eFOB);
      if (_oz(z, 1, e, s, gg)) {
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/ETFPage/etfhotspotdetail.wxss"] =
    setCssToHead([], undefined, {
      path: "./pages/market/pages/ETFPage/etfhotspotdetail.wxss",
    });
}
