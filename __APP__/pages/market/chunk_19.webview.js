$gwx5_XC_11 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var e0MB = _n("page-meta");
      _rz(z, e0MB, "rootFontSize", 0, e, s, gg);
      _(r, e0MB);
      var bANB = _n("view");
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/TRankPage.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/TRankPage.wxss" }
  );
}
