$gwx5_XC_7 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var lMLB = _n("page-meta");
      _rz(z, lMLB, "rootFontSize", 0, e, s, gg);
      _(r, lMLB);
      var cKLB = _v();
      _(r, cKLB);
      if (_oz(z, 1, e, s, gg)) {
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/NewPubETFTeach.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/NewPubETFTeach.wxss" }
  );
}
