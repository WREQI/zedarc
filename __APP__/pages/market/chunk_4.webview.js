$gwx5_XC_14 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var lYNB = _n("page-meta");
      _rz(z, lYNB, "rootFontSize", 0, e, s, gg);
      _(r, lYNB);
      var cWNB = _v();
      _(r, cWNB);
      if (_oz(z, 1, e, s, gg)) {
        ...
        var aZNB = _mz(
          ...
          ["bind:__l", 2, "class", 1, "uI", 2, "uP", 3, "uR", 4],
          [],
          e,
          s,
          gg
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/ETFPage/buyIndexLanding.wxss"] =
    setCssToHead([], undefined, {
      path: "./pages/market/pages/ETFPage/buyIndexLanding.wxss",
    });
}
