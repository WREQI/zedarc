$gwx5_XC_12 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var hGNB = _n("page-meta");
      _rz(z, hGNB, "rootFontSize", 0, e, s, gg);
      _(r, hGNB);
      var cFNB = _v();
      _(r, cFNB);
      if (_oz(z, 1, e, s, gg)) {
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/CommonView.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/CommonView.wxss" }
  );
}
