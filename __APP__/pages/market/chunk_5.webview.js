$gwx5_XC_15 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var x5NB = _n("page-meta");
      _rz(z, x5NB, "rootFontSize", 0, e, s, gg);
      _(r, x5NB);
      var o6NB = _mz(
        z,
        "hot-topic-list-page",
        ["bind:__l", 1, "bindscroll", 1, "uI", 2],
        [],
        e,
        s,
        gg
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/ETFPage/etfhotlist.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/ETFPage/etfhotlist.wxss" }
  );
}
