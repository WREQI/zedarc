$gwx5_XC_18 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var cOOB = _n("page-meta");
      _rz(z, cOOB, "rootFontSize", 0, e, s, gg);
      _(r, cOOB);
      var hMOB = _v();
      _(r, hMOB);
      if (_oz(z, 1, e, s, gg)) {
...
if (!noCss) {
  __wxAppCode__["pages/market/pages/ETFPage/etfzonebonus.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/market/pages/ETFPage/etfzonebonus.wxss" }
  );
}
