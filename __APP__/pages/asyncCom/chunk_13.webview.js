  ...
  return function (path, global) {
    ...
    function gz$gwx1_XC_5_1() {
      ...
      (function (z) {
        ...
        Z([[7], [3, "a"]]);
        Z([3, "_div reward-main"]);
        Z([3, "_span reward-num"]);
        Z([a, [[7], [3, "b"]]]);
        Z([3, "_span reward-unit"]);
        Z([a, [[7], [3, "c"]]]);
        Z(z[1]);
        Z([a, [[7], [3, "d"]]]);
      })(__WXML_GLOBAL__.ops_cached.$gwx1_XC_5_1);
...
if (!noCss) {
  __wxAppCode__[
    "pages/asyncCom/@tencent/st-reward-core/components/reward.wxss"
  ] = setCssToHead([], undefined, {
    path: "./pages/asyncCom/@tencent/st-reward-core/components/reward.wxss",
  });
}
