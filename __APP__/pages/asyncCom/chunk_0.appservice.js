  ...
  return function (path, global) {
    ...
    function gz$gwx1_XC_0_1() {
      ...
      (function (z) {
        ...
        Z([[7], [3, "e"]]);
        Z([[7], [3, "f"]]);
        Z([3, "yy-task-count-down data-v-d6158106"]);
        Z([3, "d6158106-0"]);
        Z([[7], [3, "g"]]);
        Z([[4], [[5], [[5], [1, "slot-text"]], [1, "slot-sub-text"]]]);
        Z([[7], [3, "h"]]);
        Z(z[2]);
        Z([[7], [3, "j"]]);
        Z([3, "yy-task-bubble data-v-d6158106"]);
        Z([3, "d6158106-1"]);
        Z([[7], [3, "k"]]);
        Z([[4], [[5], [1, "yy-bubble-text"]]]);
        Z([[7], [3, "l"]]);
        Z(z[2]);
        Z([[7], [3, "o"]]);
        Z([
          ...
          [
            [5],
            [[5], [[5], [1, "yy-task-guide"]], [1, "data-v-d6158106"]],
            [[7], [3, "n"]],
          ],
        ]);
        Z([3, "d6158106-2"]);
        ...
        Z([[7], [3, "w"]]);
        Z([[7], [3, "v"]]);
        Z([3, "yy-task-snackbar data-v-d6158106"]);
        Z([3, "d6158106-3"]);
        Z([[7], [3, "x"]]);
        Z([
          [4],
          [[5], [[5], [1, "yy-snackbar-text"]], [1, "yy-snackbar-btn-text"]],
        ]);
        Z([3, "yy-snackbar-text"]);
        Z([[7], [3, "r"]]);
        Z([[7], [3, "y"]]);
        Z(z[2]);
        Z([[7], [3, "B"]]);
        Z([3, "yy-task-banner data-v-d6158106"]);
        Z([3, "d6158106-4"]);
        Z([[7], [3, "C"]]);
        Z([[4], [[5], [1, "yy-snackbar-text"]]]);
        Z(z[31]);
        Z([[7], [3, "z"]]);
      })(__WXML_GLOBAL__.ops_cached.$gwx1_XC_0_1);
      return __WXML_GLOBAL__.ops_cached.$gwx1_XC_0_1;
    ...
    var x = ["./pages/asyncCom/@tencent/st-act-component/h5/task/index.wxml"];
    d_[x[0]] = {};
...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/asyncCom/@tencent/st-act-component/h5/task/index.wxml"] =
    [
      $gwx1_XC_0,
      "./pages/asyncCom/@tencent/st-act-component/h5/task/index.wxml",
    ];
else
  __wxAppCode__["pages/asyncCom/@tencent/st-act-component/h5/task/index.wxml"] =
    $gwx1_XC_0("./pages/asyncCom/@tencent/st-act-component/h5/task/index.wxml");
__wxRoute = "pages/asyncCom/@tencent/st-act-component/h5/task/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ =
  "pages/asyncCom/@tencent/st-act-component/h5/task/index.js";
define(
  "pages/asyncCom/@tencent/st-act-component/h5/task/index.js",
  function (
    require,
    ...
    var t,
      ...
      y = {
        ...
        countdown: {
          logo: "https://wzq.gtimg.com/image/activity/icon-count.png",
        },
        snackbar: {
          button: { text: "更多福利" },
          text: function (t) {
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            ...
                            return (
                              this.initPath(), (e.next = 4), this.loadConfs()
                            );
                          case 4:
                            if (
                              ...
                              (null == (r = this.curTask) ? void 0 : r.actid) &&
                                (this.uiConf =
                                  x[this.curTask.actid] || x.default),
                              !this.options)
                            ) {
                              e.next = 12;
                              break;
                        ...
                        case 30:
                          if (
                            ((this.bubble = {
                              ...
                              allowClose: m,
                              closable: m,
                              bubbleid: "yy-bubble-task".concat(
                                this.curTask.tid
                              ),
                              visible: !0,
                              duration: v,
            ...
            if (t) {
              ...
              (this.snackbar = {
                ...
                (this.snackbarTimer = setTimeout(function () {
                  e.hideSnackbar();
                }, 1e3 * ((null == r ? void 0 : r.duration) || i.duration) ||
                  0));
            }
          },
          hide: function (t) {
          ...
          return m.e(
            ...
            a.countdown && a.countdown.visible
              ? {
                  ...
                  c: a.taskAward ? "" : 1,
                  d: m.t(
                    a.taskAward ? "返回查看" : a.countdown.text || "得奖励"
                  ),
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/asyncCom/@tencent/st-act-component/h5/task/index.js",
  }
);
require("pages/asyncCom/@tencent/st-act-component/h5/task/index.js");
