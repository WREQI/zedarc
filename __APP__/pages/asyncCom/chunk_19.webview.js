$gwx1_XC_11 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var oJI = _mz(z, "image", ["class", 1, "src", 1], [], e, s, gg);
      _(xII, oJI);
      _(r, xII);
      return r;
    };
...
if (!noCss) {
  __wxAppCode__[
    "pages/asyncCom/@tencent/stock-mini-mins/component/StockItemChart.wxss"
  ] = setCssToHead(
    [
      ".",
      [1],
      "min-line-chart{height:.8533333333333334rem;pointer-events:none;width:1.6rem}\n.",
      [1],
      "min-line-chart.",
      [1],
    ...
    undefined,
    {
      path: "./pages/asyncCom/@tencent/stock-mini-mins/component/StockItemChart.wxss",
    }
  );
}
