...
if (!noCss) {
  __wxAppCode__[
    "pages/asyncCom/@tencent/stock-mini-mins/component/StockItemChartV2.wxss"
  ] = setCssToHead(
    [
      ".",
      [1],
      "mini-chart-wrap{display:-webkit-flex;display:flex}\n.",
      [1],
      "min-line-chart{pointer-events:none;width:.8rem}\n.",
      [1],
      "min-line-chart,.",
      [1],
      "min-line-chart.",
      [1],
      "chart-height{height:.7466666666666667rem}\n.",
      [1],
      "min-line-chart.",
      [1],
      "mini{height:.4266666666666667rem;width:.72rem}\n.",
      [1],
      "min-line-chart.",
      [1],
      "mini.",
      [1],
      "chart-height{height:.64rem}\n",
    ],
    undefined,
    {
      path: "./pages/asyncCom/@tencent/stock-mini-mins/component/StockItemChartV2.wxss",
    }
  );
}
