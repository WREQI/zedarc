      ...
      return (
        ...
        "jj" === c
          ...
          : o &&
            ...
            (c = "cnjj"),
        "sh" === c && n && /^68/.test(n) && (c = "ke"),
        "sz" === c && n && /^30/.test(n) && (c = "chuang"),
        c
      );
    }
  };
(exports.IPO_STATE_LISTED = "U"),
  ...
  (exports.formatBigToText = function (t, e, r, n, s) {
    return (
      (t = parseFloat(t || 0)),
      (e = parseInt(e || 1, 10)),
      (r = parseInt(r || 0, 10)),
  ...
  (exports.splitSymbol = function (t) {
    if (n.includes(t)) return { market: "ft", scode: t };
    var e = t.slice(0, 2),
      r = ["sz", "sh", "hk", "us"].indexOf(e);
    return { market: -1 === r ? e : "".concat(r), scode: t.slice(2) };
  }),
  (exports.transMarket = a),
  (exports.transMarketIcon = function (t, e, r) {
