$gwx47_XC_23 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx47_XC_23 || [];
    function gz$gwx47_XC_23_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx47_XC_23_1)
        return __WXML_GLOBAL__.ops_cached.$gwx47_XC_23_1;
      __WXML_GLOBAL__.ops_cached.$gwx47_XC_23_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        }
        Z([3, "_div etf-invest-card-header data-v-40d06035"]);
        Z([[7], [3, "a"]]);
        Z([[7], [3, "b"]]);
        Z([3, "__l"]);
        Z([3, "etf-invest-card__logo-chart data-v-40d06035"]);
        Z([3, "40d06035-0"]);
        Z(z[2]);
        Z([[7], [3, "e"]]);
        Z([[7], [3, "n"]]);
    ...
    __WXML_GLOBAL__.ops_set.$gwx47_XC_23 = z;
    __WXML_GLOBAL__.ops_init.$gwx47_XC_23 = true;
    var x = [
      "./pages/marketSbg/@tencent/stock-hq-etf/components/EtfInvestHeader.wxml",
    ];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx47_XC_23_1();
      var aHZ = _n("view");
...
if (__vd_version_info__.delayedGwx || false) $gwx47_XC_23();
...
__wxRoute = "pages/marketSbg/@tencent/stock-hq-etf/components/EtfInvestHeader";
__wxRouteBegin = true;
__wxAppCurrentFile__ =
  "pages/marketSbg/@tencent/stock-hq-etf/components/EtfInvestHeader.js";
define(
  "pages/marketSbg/@tencent/stock-hq-etf/components/EtfInvestHeader.js",
  function (
    require,
    ...
    var g = require("../global-invest/utils/report.js"),
      ...
      h = f.defineComponent({
        ...
        setup: function (t, r) {
          ...
          var n = (
            ...
            S = f.computed(function () {
              var e,
                ...
                a =
                  null !=
                  (o = null == (e = t.featuredEtf) ? void 0 : e.price_ratio)
                    ? o
                    : null ==
          ...
          function w() {
            var e =
                v.sls.getItem("_qluin") || f.StockBridge.getStorage("_qluin"),
              t =
                v.sls.getItem("_qlskey") || f.StockBridge.getStorage("_qlskey");
            return {
                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                              ...
                              if (
                                ("home_long_term" === t.reportSource &&
                                  g.reportGlobalInvest(
                                    g.GLOBAL_INVEST_REPORT
                                      .HOME_LONG_TERM_ADD_CLICK,
                            ...
                            case 15:
                              return (
                                (e.next = 17),
                                o.proxy.$sdk.removeStockFromGroup(v)
                              );
                            case 17:
                              e.t0 = e.sent;
                            case 18:
                            ...
                            case 39:
                              return (
                                (e.prev = 39), (c.value = !1), e.finish(39)
                              );
                            case 42:
                            case "end":
                              return e.stop();
...
require("pages/marketSbg/@tencent/stock-hq-etf/components/EtfInvestHeader.js");
