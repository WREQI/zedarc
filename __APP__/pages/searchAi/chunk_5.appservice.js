$gwx14_XC_8 = (function (
  ...
  return function (path, global) {
    ...
    var z = __WXML_GLOBAL__.ops_set.$gwx14_XC_8 || [];
    function gz$gwx14_XC_8_1() {
      if (__WXML_GLOBAL__.ops_cached.$gwx14_XC_8_1)
        return __WXML_GLOBAL__.ops_cached.$gwx14_XC_8_1;
      __WXML_GLOBAL__.ops_cached.$gwx14_XC_8_1 = [];
      (function (z) {
        var a = 11;
        function Z(ops) {
          z.push(ops);
        ...
        Z([
          ...
          [
            ...
            [
              [5],
              [[5], [[5], [1, "_div"]], [1, "quick-search-container"]],
              [1, "data-v-c4e1891e"],
            ],
            [[7], [3, "F"]],
          ],
        ...
        Z([[7], [3, "b"]]);
        Z([3, "_div quickSearch data-v-c4e1891e"]);
        Z([[7], [3, "c"]]);
        Z([[7], [3, "d"]]);
        Z([[7], [3, "f"]]);
        Z([[7], [3, "j"]]);
    ...
    __WXML_GLOBAL__.ops_set.$gwx14_XC_8 = z;
    __WXML_GLOBAL__.ops_init.$gwx14_XC_8 = true;
    var x = ["./pages/searchAi/@tencent/stock-ai-quick-search/Index.wxml"];
    d_[x[0]] = {};
    var m0 = function (e, s, r, gg) {
      var z = gz$gwx14_XC_8_1();
      var fSO = _v();
      _(r, fSO);
      if (_oz(z, 0, e, s, gg)) {
        fSO.wxVkey = 1;
        ...
        if (_oz(z, 2, e, s, gg)) {
          ...
          if (_oz(z, 7, e, s, gg)) {
            aZO.wxVkey = 1;
            var e2O = _mz(z, "view", ["bindtap", 8, "class", 1], [], e, s, gg);
            var b3O = _v();
            _(e2O, b3O);
            if (_oz(z, 10, e, s, gg)) {
              b3O.wxVkey = 1;
          ...
          if (_oz(z, 17, e, s, gg)) {
            c8O.wxVkey = 1;
            var h9O = _mz(z, "view", ["bindtap", 18, "class", 1], [], e, s, gg);
            var o0O = _v();
            _(h9O, o0O);
            if (_oz(z, 20, e, s, gg)) {
              o0O.wxVkey = 1;
...
if (__vd_version_info__.delayedGwx || false) $gwx14_XC_8();
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/searchAi/@tencent/stock-ai-quick-search/Index.wxml"] = [
    $gwx14_XC_8,
    "./pages/searchAi/@tencent/stock-ai-quick-search/Index.wxml",
  ];
else
  __wxAppCode__["pages/searchAi/@tencent/stock-ai-quick-search/Index.wxml"] =
    $gwx14_XC_8("./pages/searchAi/@tencent/stock-ai-quick-search/Index.wxml");
__wxRoute = "pages/searchAi/@tencent/stock-ai-quick-search/Index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/searchAi/@tencent/stock-ai-quick-search/Index.js";
define(
  "pages/searchAi/@tencent/stock-ai-quick-search/Index.js",
  function (
    require,
    module,
    exports,
                          ...
                          case 2:
                            (o = B(n, t)),
                              ...
                              (function (e, n) {
                                ...
                                (f = l.wx$1.request(a)).onChunkReceived(
                                  function (e) {
                                    try {
                                      g(e, t);
                                    } catch (n) {
                  ...
                  if (n)
                    if (
                      ...
                      d.ENV === l.EnvTypeEnum.MP &&
                        "app_lct" ===
                          (null == (e = d.store) ? void 0 : e.lctfrom))
                    ) {
                                      ...
                                      r: l.f(
                                        ...
                                        function (n, t, r) {
                                          return {
                                            ...
                                            c: l.o(
                                              function (t) {
                                                return e.handleFollowOnItemClick(
                                                  n
                                                );
                                              },
                                              4128,
  ...
  },
  {
    isPage: false,
    isComponent: true,
    currentFile: "pages/searchAi/@tencent/stock-ai-quick-search/Index.js",
  }
);
require("pages/searchAi/@tencent/stock-ai-quick-search/Index.js");
