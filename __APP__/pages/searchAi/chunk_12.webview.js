$gwx14_XC_4 = (function (
  ...
  return function (path, global) {
    ...
    var m0 = function (e, s, r, gg) {
      ...
      var aXC = _n("page-meta");
      _rz(z, aXC, "rootFontSize", 0, e, s, gg);
      _(r, aXC);
      var tYC = _mz(z, "view", ["class", 1, "data-st-theme", 1], [], e, s, gg);
      var o2C = _mz(
        z,
        "mp-privacy-dialog",
        ["bind:__l", 3, "uI", 1],
...
if (!noCss) {
  __wxAppCode__["pages/searchAi/jgpjDetail.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./pages/searchAi/jgpjDetail.wxss" }
  );
}
