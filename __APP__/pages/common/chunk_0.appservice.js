...
if (__vd_version_info__.delayedGwx)
  __wxAppCode__["pages/common/index.wxml"] = [
    $gwx8_XC_0,
    "./pages/common/index.wxml",
  ];
else
  __wxAppCode__["pages/common/index.wxml"] = $gwx8_XC_0(
    "./pages/common/index.wxml"
  );
__wxRoute = "pages/common/index";
__wxRouteBegin = true;
__wxAppCurrentFile__ = "pages/common/index.js";
define(
  ...
  { isPage: true, isComponent: true, currentFile: "pages/common/index.js" }
);
