  ...
  return function (path, global) {
    ...
    function gz$gwx8_XC_1_1() {
      ...
      (function (z) {
        ...
        Z([3, "_div lottie-animation-container"]);
        Z([[7], [3, "r0"]]);
        Z([[7], [3, "d"]]);
        Z([[7], [3, "a"]]);
        Z([
    ...
    var m0 = function (e, s, r, gg) {
      ...
      if (_oz(z, 1, e, s, gg)) {
        ...
        var fE = _mz(
          z,
          "canvas",
          ["disableScroll", 2, "id", 1, "style", 2, "type", 3],
          [],
          e,
          s,
          gg
...
if (!noCss) {
  __wxAppCode__["pages/common/lottie.wxss"] = setCssToHead([], undefined, {
    path: "./pages/common/lottie.wxss",
  });
}
