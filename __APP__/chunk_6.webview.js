    ...
    var m0 = function (e, s, r, gg) {
      ...
      if (_oz(z, 1, e, s, gg)) {
        ...
        var bMJ = _mz(
          ...
          ["bind:__l", 2, "bindinput", 1, "uI", 2, "uP", 3],
          [],
          e,
          s,
          gg
...
if (!noCss) {
  __wxAppCode__["components/StockPrivacyDialog/index.wxss"] = setCssToHead(
    [],
    undefined,
    { path: "./components/StockPrivacyDialog/index.wxss" }
  );
}
